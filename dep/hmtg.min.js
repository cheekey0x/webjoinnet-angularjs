...
this.read;h<this.data.length;++h,++e)m[e]=this.data.charCodeAt(h);return b};e.g.prototype.Pb=function(){for(var b="",m=this.read;m<this.data.length;++m){var e=this.data.charCodeAt(m);16>e&&(b+="0");b+=e.toString(16)}return b};e.g.prototype.toString=function(){return e.Ab(this.u())};e.createBuffer=function(b,m){void 0!==b&&"utf8"===(m||"raw")&&(b=e.qb(b));return new e.g(b)};e.Gj=function(){for(var b=String.fromCharCode(0),m=64,e="";0<m;)m&1&&(e+=b),m>>>=1,0<m&&(b+=b);return e};e.cG=function(b,m,e){for(var p=
...
h=v[b.charCodeAt(d++)-43],c=v[b.charCodeAt(d++)-43],a=v[b.charCodeAt(d++)-43],p+=String.fromCharCode(e<<2|h>>4),64!==c&&(p+=String.fromCharCode((h&15)<<4|c>>2),64!==a&&(p+=String.fromCharCode((c&3)<<6|a)));return p};e.Bj=function(b){return e.Ib(b.replace(/[-|_]/g,function(b){return"-"==b?"+":"/"}))};e.qb=function(b){try{return unescape(encodeURIComponent(b))}catch(m){return b}};e.Ab=function(b){try{return decodeURIComponent(escape(b))}catch(m){return b}};e.tr=function(b){var p;return p=e.Ib(b.tr(e.oc(p)).og)};
e.Kr=function(b){b=b.Kr(e.oc(void 0)).og;return null===b?null:e.Ib(b)};e.setItem=function(b,m,e,c,t){H(h,arguments,t)};e.getItem=function(b,m,e,h){return H(y,arguments,h)};e.removeItem=function(b,m,e,h){H(c,arguments,h)};e.SB=function(b,m,e){H(F,arguments,e)};e.bt=function(b){var m=/\/\/\[.+\]:/.test(b)?/^(https?):\/\/\[(.+)\]:?(\d*)(.*)$/g:/^(https?):\/\/([^:&^\/]*):?(\d*)(.*)$/g;m.lastIndex=0;m=m.exec(b);if(b=null===m?null:{Br:b,scheme:m[1],host:m[2],port:m[3],path:m[4]})b.Ke=b.host,b.port?80!=
b.port&&"http"===b.scheme?b.Ke+=":"+b.port:443!=b.port&&"https"===b.scheme&&(b.Ke+=":"+b.port):"http"===b.scheme?b.port=80:"https"===b.scheme&&(b.port=443),b.Br=b.scheme+"://"+b.Ke;return b};var B=null;e.Ir=function(b){function m(b){var m={};b=b.split("&");for(var e=0;e<b.length;e++){var a=b[e].indexOf("=");if(0<a){var d=b[e].substring(0,a);a=b[e].substring(a+1)}else d=b[e],a=null;d in m||(m[d]=[]);d in Object.prototype||null===a||m[d].push(unescape(a))}return m}"undefined"===typeof b?(null===B&&
("undefined"===typeof window?B={}:B=m(window.location.search.substring(1))),b=B):b=m(b);return b};e.at=function(b){var m=b,h="",p=b.indexOf("?");0<p&&(m=b.substring(0,p),h=b.substring(p+1));b=m.split("/");0<b.length&&""===b[0]&&b.shift();p=""===h?{}:e.Ir(h);return{dt:m,it:h,path:b,query:p}};e.JF=function(b){var m=e.at(b),h={path:m.dt,query:m.it,Hr:function(b){return"undefined"===typeof b?m.path:m.path[b]},Sd:function(b,e){"undefined"===typeof b?b=m.query:(b=m.query[b])&&"undefined"!==typeof e&&(b=
b[e]);return b},aC:function(b,e){return(b=h.Sd(b))?b[b.length-1]:e}};return h};e.IF=function(){};e.ZF=function(b,e,h){if("object"===typeof b&&null!==b)for(var m=0,p=e.length;m<p;){var a=e[m++];if(m==p)b[a]=h;else{var d=a in b;if(!d||d&&"object"!==typeof b[a]||d&&null===b[a])b[a]={};b=b[a]}}};e.Hr=function(b,e,h){for(var m=0,c=e.length,a=!0;a&&m<c&&"object"===typeof b&&null!==b;){var d=e[m++];(a=d in b)&&(b=b[d])}return a?b:h};e.VB=function(b,e){if("object"===typeof b&&null!==b)for(var m=0,h=e.length;m<
...
e.vf=function(b,e,h,c){var m=isNaN(e=Math.abs(e))?2:e;e=void 0===h?",":h;c=void 0===c?".":c;h=0>b?"-":"";var a=parseInt(b=Math.abs(+b||0).toFixed(m),10)+"",d=3<a.length?a.length%3:0;return h+(d?a.substr(0,d)+c:"")+a.substr(d).replace(/(\d{3})(?=\d)/g,"$1"+c)+(m?e+Math.abs(b-a).toFixed(m).slice(2):"")};e.YB=function(b){return b=1073741824<=b?e.vf(b/1073741824,2,".","")+" GiB":1048576<=b?e.vf(b/1048576,2,".","")+" MiB":1024<=b?e.vf(b/1024,0)+" KiB":e.vf(b,0)+" bytes"};e.gr=function(b){return-1!==b.indexOf(".")?
e.hr(b):-1!==b.indexOf(":")?e.ir(b):null};e.hr=function(b){b=b.split(".");if(4!==b.length)return null;for(var h=e.createBuffer(),c=0;c<b.length;++c){var p=parseInt(b[c],10);if(isNaN(p))return null;h.o(p)}return h.ya()};e.ir=function(b){var h=0;b=b.split(":").filter(function(a){0===a.length&&++h;return!0});for(var c=2*(8-b.length+h),p=e.createBuffer(),t=0;8>t;++t)if(b[t]&&0!==b[t].length){var a=e.Ic(b[t]);2>a.length&&p.o(0);p.K(a)}else p.eh(0,c),c=0;return p.ya()};e.PB=function(b){return 4===b.length?
e.jr(b):16===b.length?e.kr(b):null};e.jr=function(b){if(4!==b.length)return null;for(var e=[],h=0;h<b.length;++h)e.push(b.charCodeAt(h));return e.join(".")};e.kr=function(b){if(16!==b.length)return null;for(var h=[],c=[],p=0,t=0;t<b.length;t+=2){for(var a=e.Wg(b[t]+b[t+1]);"0"===a[0]&&"0"!==a;)a=a.substr(1);if("0"===a){var d=c[c.length-1],B=h.length;d&&B===d.end+1?(d.end=B,d.end-d.start>c[p].end-c[p].start&&(p=c.length-1)):c.push({start:B,end:B})}h.push(a)}0<c.length&&(b=c[p],0<b.end-b.start&&(h.splice(b.start,
...
function(b,e,h,c){return H(b,e,h,!1,c)};b.Za.qr=function(b,e){return H(b,null,null,!1,e)};b.Za.ue=function(b,e,h,c){return H(b,e,h,!0,c)};b.Za.pr=function(b,e){return H(b,null,null,!0,e)};b.Za.Uq=function(b){h||y();return c(b,!1)};b.Za.ar=F})(window.W);"undefined"===typeof window.W&&(window.W={});
...
266240,4160,4160,262208,268435456,268701696];b.mc=b.mc||{};b.mc.ve=function(b,e,h){b=H(b,!0);b.start(e,h);return b};b.mc.qr=function(b){return H(b,!0)};b.mc.ue=function(b,e,h){b=H(b,!1);b.start(e,h);return b};b.mc.pr=function(b){return H(b,!1)}})(window.W);"undefined"===typeof window.W&&(window.W={});
...
{};b.gb.He=b.gb.He||{};b.gb.Id=b.gb.He.sha1=F;var c=null,y=!1;F.create=function(){y||(c=String.fromCharCode(128),c+=b.a.Gj(),y=!0);var h=null,q=b.a.createBuffer(),E=Array(80),e={algorithm:"sha1",fr:64,ur:20,yb:0,start:function(){e.yb=0;q=b.a.createBuffer();h={rb:1732584193,sb:4023233417,tb:2562383102,ub:271733878,Td:3285377520};return e}};e.start();e.update=function(c,v){"utf8"===v&&(c=b.a.qb(c));e.yb+=c.length;q.K(c);H(h,E,q);(2048<q.read||0===q.length())&&q.compact();return e};e.digest=function(){var D=
...
!0}var c=b.Qh=b.Qh||{};b.gb=b.gb||{};b.gb.He=b.gb.He||{};b.gb.Qh=b.gb.He.md5=c;var y=null,h=null,q=null,E=null,e=!1;c.create=function(){e||F();var c=null,h=b.a.createBuffer(),q=Array(16),p={algorithm:"md5",fr:64,ur:16,yb:0,start:function(){p.yb=0;h=b.a.createBuffer();c={rb:1732584193,sb:4023233417,tb:2562383102,ub:271733878};return p}};p.start();p.update=function(e,v){"utf8"===v&&(e=b.a.qb(e));p.yb+=e.length;h.K(e);H(c,q,h);(2048<h.read||0===h.length())&&h.compact();return p};p.digest=function(){var e=
...
if(!q)return h.Fr(c);var B=h.hc.B,p=h.hc.Qj,m=h.hc.fh,I=h.hc.gh,A=b.a.createBuffer();e()};h.Fr=function(e){for(var q=h.hc.B,v=h.hc.Qj,B=h.hc.fh,p=h.hc.gh,m=b.a.createBuffer();m.length()<e;){if(1048576<=h.sd){var I=+new Date;if(null===h.time||100<I-h.time)h.key=null}null===h.key&&(32<=h.vc[0].yb||h.sf(h.mt(32-h.vc[0].yb<<5)),c());I=q(h.key,h.yc);h.sd+=I.length;m.K(I);h.key=B(q(h.key,v(h.yc)));h.yc=p(q(h.key,h.yc))}return m.ya(e)};h.Yh=function(b,c){try{c(null,y(b))}catch(v){c(v)}};h.mt=y;h.sf=function(b){for(var c=
b.length,e=0;e<c;++e)h.vc[h.lg].update(b.substr(e,1)),h.lg=31===h.lg?0:h.lg+1};h.tf=function(b,c){for(var e="",q=0;q<c;q+=8)e+=String.fromCharCode(b>>q&255);h.sf(e)};h.TF=function(b){b===self?h.Yh=function(b,c){function e(b){b=b.data;b.W&&b.W.wc&&(self.removeEventListener("message",e),c(b.W.wc.yr,b.W.wc.u))}self.addEventListener("message",e);self.postMessage({W:{wc:{$s:b}}})}:b.addEventListener("message",function(c){c=c.data;c.W&&c.W.wc&&h.Yh(c.W.wc.$s,function(c,e){b.postMessage({W:{wc:{yr:c,u:e}}})})})};
return h}})(window.W);"undefined"===typeof window.W&&(window.W={});
(function(b){b.random&&b.random.ya||function(H){var F={},c=Array(4),y=b.a.createBuffer();F.fh=function(c){var e=b.a.createBuffer(c);c=Array(4);c[0]=e.getInt32();c[1]=e.getInt32();c[2]=e.getInt32();c[3]=e.getInt32();return b.Za.Uq(c)};F.gh=function(c){var e=b.a.createBuffer(c);c=Array(4);c[0]=e.getInt32();c[1]=e.getInt32();c[2]=e.getInt32();c[3]=e.getInt32();return c};F.B=function(e,h){b.Za.ar(e,h,c,!1);y.f(c[0]);y.f(c[1]);y.f(c[2]);y.f(c[3]);return y.ya()};F.Qj=function(b){++b[3];return b};F.gb=b.gb.Id;
...
h;b.random.ya=function(c,h){return b.random.Kj(c,h)};b.random.ZB=function(c){return b.random.Kj(c)}}(null)})(window.W);"undefined"===typeof window.hmtg&&(window.hmtg={});var oa=window.hmtg,k=oa.b=oa.b||{};oa.config=oa.b;k.APP_VERSION=k.hi="";k.NORMAL=k.R=0;k.PLAYBACK=k.Fa=1;k.PLAYER=k.yz=2;k.DOWNLOAD=k.$o=3;k.UPLOAD=k.Gq=4;k.MTU_SIZE=k.Ec=500;k.TS_SIZE=k.ic=21;k.UTF8_CODEPAGE=k.pA=65001;k.RECORDING_STATUS_NORECORDING=k.Uz=0;k.RECORDING_STATUS_RESUMED=k.Wz=1;k.RECORDING_STATUS_PAUSED=k.Vz=2;k.PARTICIPANT_VIDEO_ERROR_OK=k.rq=0;k.PARTICIPANT_VIDEO_ERROR_FULL=k.jz=1;k.PARTICIPANT_VIDEO_ERROR_NOTSUPPORTED=k.mz=2;
k.PARTICIPANT_VIDEO_ERROR_NOTONLINE=k.lz=3;k.PARTICIPANT_VIDEO_ERROR_NOCAP=k.kz=4;k.PARTICIPANT_AUDIO_ERROR_FULL=k.dz=5;k.PARTICIPANT_AUDIO_ERROR_NOTSUPPORTED=k.ez=6;k.MAX_USER=k.Ha=5E3;k.MAX_USERID=k.py=128;k.MAX_PASSWORD=k.fj=28;k.MAX_USERNAME=k.Ya=128;k.MAX_EMAIL=k.Hp=128;k.MAX_USERAUTH=k.Mp=1E4;k.MAX_SESSIONID=k.my=20;k.MAX_SESSIONID_PL=k.ny=500;k.MAX_MEMBERID=k.hy=20;k.MAX_REGION=k.ly=128;k.MAX_URL=k.ij=4096;k.MAX_SLIDENAME=k.hj=600;k.MAX_XML_DATA=k.qy=9E3;
k.MAX_THIRDPARTY_MEETINGTITLE=k.Qg=512;k.MAX_THIRDPARTY_MEETINGID=k.Lp=128;k.DEFAULT_MAX_BANDWIDTH=k.xw=24E3;k.BANDWIDTH_FOR_AUDIO=k.Ct=1E4;k.MAX_BANDWIDTH=k.ej=5E6;k.MIN_BANDWIDTH_FOR_VIDEO=k.Np=1E4;k.JN_ERROR_BASE=k.qf=2E4;k.JN_GC_ERROR_BASE=k.Gx=25E3;k.JN_PROXY_ERROR_BASE=k.Px=3E4;k.JN_SLIDE_ERROR_BASE=k.Zx=35E3;var U=k.JN_CODE_BASE=k.vx=5E4;k.JN_PRINTER_DRIVER_BASE=k.Ox=7E4;k.JN_MCU_RELAY_BASE=k.bj=71E3;k.JN_OK=k.Nx=0;k.JN_UNKNOWN_ERROR=k.Mg=U+0;k.JN_RESOLVE_PROXY=k.Xx=U+1;
k.JN_CONNECTING_GC=k.wx=U+2;k.JN_BLANK=k.ux=U+3;k.JN_CONNECT_GC_UNKNOWN_ERROR=k.yx=U+4;k.JN_FAIL_CONNECT_GC=k.Cx=U+5;k.JN_CONNECT_GC_BROKEN=k.xx=U+6;k.JN_CONNECTING_MCU=k.pp=U+7;k.JN_FAIL_CONNECT_MCU=k.Ld=U+8;k.JN_NO_SCHEDULE=k.Mx=U+9;k.JN_WRONG_IP_PASSWD=k.ey=U+10;k.JN_WRONG_AUTH_PASSWD=k.dy=U+11;k.JN_MEETING_NOT_EXIST2=k.xp=U+12;k.JN_TOOMANY_USER_2=k.ay=U+13;k.JN_CONNECTION_ESTABLISHED=k.qp=U+14;k.JN_QUESTION_CANCEL_DUE_TRANSFER=k.Sx=U+15;k.JN_YOU_HAVENOT_TOKEN=k.fy=U+16;k.JN_NEW_USER=k.Kx=U+17;
k.JN_USER_LEAVE=k.by=U+18;k.JN_QUESTION_FINISH=k.Tx=U+19;k.JN_USER_QUESTION_START=k.cy=U+20;k.JN_QUESTION_ACCEPTED=k.Qx=U+21;k.JN_QUESTION_IN_QUEUE=k.Ux=U+22;k.JN_QUESTION_SKIPPED=k.Vx=U+23;k.JN_DISCONNECT_BY_OWNER=k.tp=U+24;k.JN_MEETING_OVER=k.yp=U+25;k.JN_QUESTION_CANCELED=k.Rx=U+26;k.JN_USER_OVERWRITE=k.Cp=U+27;k.JN_YOU_HAVE_TOKEN=k.gy=U+28;k.JN_FILE_READ_ERROR=k.Fx=U+29;k.JN_FILE_PAGE_ERROR=k.Ex=U+30;k.JN_NO_MCU=k.Lx=U+31;k.JN_CONNECT_PROXY_NO_CONNECT_MCU=k.zx=U+32;
k.JN_MCU_TALK_MISMATCH=k.Jx=U+33;k.JN_TESTING_AV=k.$x=U+34;k.JN_FAIL_UDP=k.Dx=U+35;k.JN_CORRUPT_SERVER_PARAMETER=k.Ax=U+36;k.JN_DELETE_FILE_OK=k.sp=U+37;k.JN_DELETE_FILE_FAIL=k.rp=U+38;k.JN_JNJ_FILE_READ_ERROR=k.Hx=U+39;k.JN_JNJ_UNKNOWN_CODE_TYPE=k.Ix=U+40;k.JN_JNR_FILE_ERROR=k.wp=U+41;k.JN_MEETING_TERMINATED=k.zp=U+42;k.JN_PREPARATION_MODE=k.Ap=U+43;k.JN_PREPARATION_SWITCH_TO_NORMAL=k.Bp=U+44;k.JN_SHARE_DESKTOP_FAIL=k.Yx=U+45;k.JN_REQUEST_DESKTOP_FAIL=k.Wx=U+46;
k.JN_DESKTOP_CONFLICT_MCURELAY=k.Bx=U+47;k.JN_EARLY_DISCONNECTION_1=k.up=U+48;k.JN_EARLY_DISCONNECTION_2=k.vp=U+49;k.ERROR_WRONG_USERID=k.mp=255;k.ERROR_WRONG_PASSWD=k.Vi=254;k.ERROR_ALREADY_LOGGED=k.Mw=253;k.ERROR_VERSION=k.ox=252;k.ERROR_PARAMETER=k.ax=251;k.ERROR_SESSIONID=k.jx=250;k.ERROR_MEETING_NOT_EXIST=k.ap=249;k.ERROR_INTERNAL=k.Uw=248;k.ERROR_FILE_ERROR=k.Rw=247;k.ERROR_TOOMANY_PLAYBACK=k.lx=246;k.ERROR_ILLEGAL_FILE=k.Sw=245;k.ERROR_FILE_WRONG_VERSION=k.Ui=244;
k.ERROR_WRONG_PASSWD2=k.px=243;k.ERROR_TOOMANY_DOWNLOAD=k.kx=242;k.ERROR_TOOMANY_USER=k.mx=241;k.ERROR_CALL_REJECTED=k.Ow=240;k.ERROR_CALL_NOT_ACCEPTED=k.Nw=239;k.ERROR_JOINNETMODE=k.Ww=238;k.ERROR_USER_NOT_CONTINUE=k.lp=237;k.ERROR_SESSION_CLOSED=k.kp=236;k.ERROR_TOO_MANY_SESSION=k.nx=235;k.ERROR_CAN_NOT_RECORD=k.Pw=234;k.ERROR_MESSAGE_NOT_EXIST=k.Yw=233;k.ERROR_LINE_BUSY=k.Xw=232;k.ERROR_FILE_NEED_HIGHER_VERSION=k.Ti=231;k.ERROR_EXCEED_DISK_QUOTA=k.Qw=230;k.ERROR_WRONG_USERINFO2=k.qx=229;
k.ERROR_OWNER_IN_PREPARATION_MODE=k.$w=228;k.ERROR_PREPARATION_MODE_TOO_LATE=k.ix=227;k.ERROR_ILLEGAL_REQUEST=k.Tw=226;k.ERROR_OUT_OF_MEMORY=k.Zw=225;k.ERROR_INVALID_LICENSE=k.Vw=224;k.ERROR_REQUEST_REJECTED=k.jp=223;k.MRP_ERROR_CONTINUE=k.Dc=1;k["MRP_ERROR_QUITPROGRAM\t"]=k.Py=2;k.MRP_ERROR_NOTALLOWED=k.My=3;k.MRP_ERROR_BUSY=k.Jy=4;k.MRP_ERROR_NOTSUPPORTED=k.Ny=5;k.MRP_ERROR_CONNECTFAIL=k.Ky=6;k.MRP_ERROR_NOSESSIONGROUP=k.Ly=7;k.MRP_ERROR_SLIDENOTREADY=k.Op=8;k.MRP_ERROR_ONLY_PRIMARY_PORT=k.Oy=9;
k.CONNECTION_STATUS_INIT=k.Ni=1;k.CONNECTION_STATUS_RESOLVING=k.tw=2;k.CONNECTION_STATUS_CONNECTTING=k.Ki=3;k.CONNECTION_STATUS_SIGN_IN=k.Oi=4;k.CONNECTION_STATUS_CONNECTED=k.pa=5;k.CONNECTION_STATUS_PARSE_HOMEPAGE=k.sw=6;k.CONNECTION_STATUS_DOWNLOAD_JNJ=k.Ao=7;k.CONNECTION_STATUS_E_UNKNOWN_ERROR=k.Po=1E4;k.CONNECTION_STATUS_E_RESOLVING=k.rw=10001;k.CONNECTION_STATUS_E_FAIL_CONNECT=k.Fo=10002;k.CONNECTION_STATUS_E_BROKEN_CONNECT=k.Li=10003;k.CONNECTION_STATUS_E_INVALID_S_STRING=k.fw=10004;
k.CONNECTION_STATUS_E_NOT_SUPPORTED=k.hw=10005;k.CONNECTION_STATUS_E_WRONG_USERID_LEN=k.Cc=10006;k.CONNECTION_STATUS_E_WRONG_USERNAME_LEN=k.hb=10007;k.CONNECTION_STATUS_E_WRONG_JNJ_LEN=k.cd=10008;k.CONNECTION_STATUS_E_ERROR_PARAMETER=k.pf=10009;k.CONNECTION_STATUS_E_BUSY=k.Do=10010;k.CONNECTION_STATUS_E_INVALID_USERID=k.Ho=10011;k.CONNECTION_STATUS_E_INVALID_PASSWORD=k.Go=10012;k.CONNECTION_STATUS_E_MEMORY_ALLOCATION=k.Io=10013;k.CONNECTION_STATUS_E_ALREADY_LOGGED=k.Bo=10014;
k.CONNECTION_STATUS_E_OVERWRITTEN=k.Oo=10015;k.CONNECTION_STATUS_E_USERID_REMOVED=k.Qo=10016;k.CONNECTION_STATUS_E_UNKNOWN_COMMAND=k.Mi=10017;k.CONNECTION_STATUS_E_WRONG_EMAIL_LEN=k.So=10018;k.CONNECTION_STATUS_E_PARSE_HOMEPAGE=k.iw=10019;k.CONNECTION_STATUS_E_DOWNLOAD_JNJ=k.Eo=10020;k.CONNECTION_STATUS_E_PARSE_IP_PORT=k.jw=10021;k.CONNECTION_STATUS_E_BREAK_MAIN_LOOP=k.Co=10022;k.CONNECTION_STATUS_E_WRONG_HOMEPAGE_LEN=k.Gg=10023;k.CONNECTION_STATUS_E_MULTIPLE_SIGNIN=k.gw=10024;
k.CONNECTION_STATUS_PREPARE_RECONNECT=k.Uo=10025;k.CONNECTION_STATUS_E_PROXY_CONNECT_FAIL=k.lw=10026;k.CONNECTION_STATUS_E_PROXY_CONNECT_BROKEN=k.kw=10027;k.CONNECTION_STATUS_E_PROXY_NO_AUTH=k.ow=10028;k.CONNECTION_STATUS_E_PROXY_NO_CONNECT=k.pw=10029;k.CONNECTION_STATUS_E_PROXY_NOT_SOCKS5=k.nw=10030;k.CONNECTION_STATUS_E_PROXY_HTTPS_FAIL=k.mw=10031;k.CONNECTION_STATUS_E_PROXY_RESOLVE=k.qw=10032;k.CONNECTION_STATUS_E_MMC_FAILURE=k.Jo=10033;k.CONNECTION_STATUS_E_NOT_SUPPORTED2=k.Ko=10034;
k.CONNECTION_STATUS_E_NO_MESSENGER=k.No=10035;k.CONNECTION_STATUS_E_NO_LICENSE=k.Lo=10036;k.CONNECTION_STATUS_E_NO_MCU=k.Mo=10037;k.CONNECTION_STATUS_E_WRONG_URL_LEN=k.To=10038;k.CONNECTION_STATUS_E_WRONG_SHORT_MESSAGE_LEN=k.Ae=10039;k.CONNECTION_STATUS_E_SIGNOUT=k.ze=10040;k.CONNECTION_STATUS_E_WRONG_CLIENT_INFO_LEN=k.Ro=10041;k.ONLINE_STATUS_ONLINE=k.Md=1;k.ONLINE_STATUS_BUSY=k.kq=2;k.ONLINE_STATUS_RIGHTBACK=k.lq=3;k.ONLINE_STATUS_AWAY=k.mj=4;k.ONLINE_STATUS_APPEAROFF=k.Rb=5;
k.ONLINE_STATUS_MOBILE=k.bz=6;k.ONLINE_STATUS_WEB=k.cz=7;k.ONLINE_STATUS_UNKNOWN=k.mq=999;k.MSGR_ERROR_UNKNOWN_ERROR=k.mq=1;k.MSGR_ERROR_CAN_NOT_PARSE=k.Uy=2;k.MSGR_ERROR_CAN_NOT_CONNECT_HOMEPAGE1=k.Ry=3;k.MSGR_ERROR_CAN_NOT_DOWNLOAD_JNJ=k.Up=4;k.MSGR_ERROR_CAN_NOT_CONNECT_HOMEPAGE2=k.Sy=5;k.MSGR_ERROR_CAN_NOT_CONNECT_HOMEPAGE3=k.Sp=6;k.MSGR_ERROR_NO_MCU_SERVER=k.gq=7;k.MSGR_ERROR_CAN_NOT_MULTIPLE_CONNECT=k.Ty=8;k.MSGR_ERROR_CAN_NOT_CONNECT_MCU=k.Tp=9;k.MSGR_ERROR_CONNECTION_BROKEN=k.jj=10;
k.MSGR_ERROR_BAD_SERVER_VERSION_STRING=k.Qy=11;k.MSGR_ERROR_SERVER_NOT_SUPPORT_MSGR=k.Vy=12;k.MSGR_ERROR_INVALID_USERID_LEN=k.Ce=13;k.MSGR_ERROR_INVALID_USERNAME_LEN=k.Ea=14;k.MSGR_ERROR_INVALID_JNJ_LEN=k.fd=15;k.MSGR_ERROR_INVALID_HOMEPAGE_LEN=k.kj=16;k.MSGR_ERROR_INVALID_PARAMETER=k.Zp=17;k.MSGR_ERROR_ALL_LINE_BUSY=k.Qp=18;k.MSGR_ERROR_INVALID_USERID=k.bq=19;k.MSGR_ERROR_INVALID_PASSWORD=k.$p=21;k.MSGR_ERROR_MEMORY_ALLOCATION=k.cq=22;k.MSGR_ERROR_ALREADY_SIGNIN=k.Rp=23;
k.MSGR_ERROR_MSGR_VERSION_NOT_SUPPORTED=k.fq=24;k.MSGR_ERROR_MSGR_BAD_CONFIGURATION=k.eq=25;k.MSGR_ERROR_NO_MSGR_LICENSE=k.hq=26;k.MSGR_ERROR_OVERWRITTEN=k.iq=27;k.MSGR_ERROR_REMOVED=k.jq=28;k.MSGR_ERROR_INVALID_EMAIL_LEN=k.Wp=29;k.MSGR_ERROR_INVALID_MMCERROR_LEN=k.Yp=30;k.MSGR_ERROR_INVALID_INTERNALID_LEN=k.Xp=31;k.MSGR_INVITE_FAILED=k.Xy=32;k.MSGR_ERROR_INVALID_URL_LEN=k.aq=33;k.MSGR_ERROR_INVALID_SHORT_MESSAGE_LEN=k.Be=34;k.MSGR_CONNECTION_STATUS_E_WRONG_HOMEPAGE_LEN=k.Pp=35;
k.MSGR_ERROR_INVALID_CLIENT_INFO_LEN=k.Vp=36;k.MSGR_ERROR_UNKNOWN_COMMAND=k.lj=37;k.MSGR_ERROR_UNKNOWN_COMMAND=k.lj=37;k.WEBOFFICE_EX_ERROR_SUCCESS=k.GA=0;k.WEBOFFICE_EX_ERROR_INVALID_LICENSE=k.wA=1;k.WEBOFFICE_EX_ERROR_GENERAL_FAILURE=k.tA=2;k.WEBOFFICE_EX_ERROR_OPEN_FILE=k.EA=3;k.WEBOFFICE_EX_ERROR_INVALID_JNR=k.vA=4;k.WEBOFFICE_EX_ERROR_NOT_ALLOW_EDIT=k.DA=5;k.WEBOFFICE_EX_ERROR_FILE_ACCESS=k.Sq=6;k.WEBOFFICE_EX_ERROR_INVALID_PASSWORD=k.xA=7;k.WEBOFFICE_EX_ERROR_SERVER_SHUTDOWN=k.FA=8;
...
k.US_ERROR_PARAMETER=k.Pq=255;k.US_ERROR_BUSY=k.Iq=254;k.US_ERROR_WRONG_USERID=k.Rq=253;k.US_ERROR_WRONG_PASSWD=k.Qq=252;k.US_ERROR_ALREADY_LOGGED=k.Hq=251;k.US_ERROR_MEMORY_ALLOCATION=k.Jq=250;k.US_ERROR_NOT_ONLINE=k.mA=249;k.US_ERROR_NOT_JOIN_SELF=k.lA=248;k.US_ERROR_NOT_READY=k.Nq=247;k.US_ERROR_OWNER_NO_RESPONSE=k.oA=246;k.US_ERROR_MMC_FAIL=k.Kq=245;k.US_ERROR_NOT_SUPPORTED=k.Oq=244;k.US_ERROR_MMC_NO_MESSENGER=k.Mq=243;k.US_ERROR_MMC_NO_LICENSE=k.Lq=242;k.US_ERROR_OFFICE_NOT_OPEN=k.nA=241;
k.US_ERROR_MMC_GENERAL=k.Ee=54321;k.US_ERROR_MMC_GENERAL=k.Ee=1;k.US_ERROR_MMC_GENERAL=k.Ee=2;k.US_ERROR_MMC_GENERAL=k.Ee=3;k.US_ERROR_MMC_GENERAL=k.Ee=4;k.US_ERROR_MMC_GENERAL=k.Ee=5;k.DEFAULT_PLAY_SOUND=k.yw=!0;k.DEFAULT_LOG_LEVEL=k.Zo=2;k.DEFAULT_ALERT_ONLINE=k.ww=!0;k.DEFAULT_ALERT_NEWMESSAGE=k.vw=!0;k.DEFAULT_SHOW_OTHER_USER=k.Aw=!0;k.DEFAULT_SHOW_OFFLINE_USER=k.zw=!0;k.CONTROLLER_ACCEPT_GUEST=k.Vo=1;k.CONTROLLER_END_MEETING=k.Wo=2;k.CONTROLLER_QUESTION_CONTROL=k.Pi=4;
k.CONTROLLER_POLL=k.Xo=8;k.CONTROLLER_SYNC=k.Hg=16;k.CONTROLLER_RETRIEVE_TOKEN=k.Qi=32;k.CONTROLLER_SYNC_TAB=k.Si=64;k.CONTROLLER_SYNC_FULLSCREEN=k.Ri=128;k.PLUG_IN_TYPE_BASE=k.Bq=128;k.AUDIO_DFLT=k.sg=129;k.AUDIO_G711=k.tg=120;k.AUDIO_ILBC=k.wg=152;k.AUDIO_G726=k.vg=168;k.AUDIO_G726_11=k.lf=184;k.AUDIO_G711_11=k.ug=255;k.AUDIO_OPUS=k.xg=232;k.VIDEO_DFLT=k.Rg=130;k.VIDEO_SPIC=k.pj=4;k.VIDEO_H264=k.Tg=200;k.VIDEO_F264=k.Sg=216;k.VIDEO_MJPG=k.Ug=248;k.VIDEO_VPX=k.Vg=64;k.MEDIA_NONE=k.Ey=0;
...
k.MEDIA_VIDEO_F264_HIGH=k.Gy=19;k.MEDIA_AUDIO_OPUS=k.Cy=20;k.SLIDE_DOWNLOAD_STATUS_UNKNOWN=k.Zz=0;k.SLIDE_DOWNLOAD_STATUS_NOTRECEIVED=k.Fq=1;k.SLIDE_DOWNLOAD_STATUS_NOTDOWNLOADED=k.Eq=2;k.SLIDE_DOWNLOAD_STATUS_PARTIALDATA=k.Yz=3;k.SLIDE_DOWNLOAD_STATUS_DOWNLOADING=k.Dq=4;k.SLIDE_DOWNLOAD_STATUS_DOWNLOADED=k.oj=5;k.MARK_STROKE=k.Dp=83;k.MARK_STROKE2=k.Ng=115;k.MARK_TEXT=k.Ep=84;k.MARK_TEXT2=k.Og=116;k.MARK_MOVE=k.dj=109;k.MARK_CUSTOMIZED=k.cj=99;k.UNDO=k.kA="UNDO";k.MAX_TEXT_LEN=k.oy=512;
k.MAX_LONG_TEXT_LEN=k.Kp=2048;k.MAX_PARTICIPANT_AUDIO_OLD=k.jy=2;k.MAX_PARTICIPANT_VIDEO_OLD=k.ky=6;k.MAX_PARTICIPANT_AUDIO=k.dd=16;k.MAX_PARTICIPANT_VIDEO=k.Qb=16;k.TAB_VIEW_BOARD=k.$z=0;k.TAB_VIEW_BROWSER=k.aA=1;k.TAB_VIEW_DESKTOP_SHARING=k.bA=2;k.TAB_VIEW_REMOTE_CONTROL=k.cA=3;k.SHOW_MYPICTURE_DELAY=k.Xz=5E3;k.MAX_MYPICTURE_SIZE=k.iy=2E5;k.MYPICTURE_TYPE_BMP=k.Yy=1;k.MYPICTURE_TYPE_GIF=k.Zy=2;k.MYPICTURE_TYPE_JPG=k.$y=3;k.MYPICTURE_TYPE_PNG=k.az=4;k.MAX_PLUG_IN_CHANNEL=k.Fb=8;
k.PLUGIN_CHANNEL_TYPE_UDP_1=k.Az=1;k.PLUGIN_CHANNEL_TYPE_TCP_2=k.zz=2;k.DT_CAPTURE_INFO=k.Cw=0;k.DT_CAPTURE_END=k.Bw=1;k.DT_SCREEN_DATA=k.Jw=2;k.DT_REQUEST_RECT=k.Iw=3;k.DT_MOUSE_POS=k.Ew=4;k.DT_NULL_DATA=k.Fw=5;k.DT_FRAME_END=k.Dw=6;k.DT_RDC_SIGNAL=k.Hw=7;k.DT_RDC_INPUT=k.Gw=8;k.DT_SCREEN_DATA1=k.Kw=9;k.DT_SCREEN_DATA2=k.Lw=10;k.RDC_CMD_END_CONTROL=k.Lz=0;k.RDC_CMD_REQUEST_CONTROL=k.Oz=1;k.RDC_CMD_ACK_REQUEST_CONTROL=k.Dz=2;k.RDC_CMD_START_CONTROL=k.Sz=3;k.RDC_CMD_DESIRED_BIT_DEPTH=k.Iz=5;
...
k.RDC_STATUS_WINDOW_SIZEMOVE=k.Tz=128;k.ERROR_PLUGIN_REQUESTCHANNEL_UNKNOWN_TYPE=k.hp=1;k.ERROR_PLUGIN_REQUESTCHANNEL_RECORDING_NOTALLOWED=k.gp=2;k.ERROR_PLUGIN_REQUESTCHANNEL_NO_RECORDING=k.fp=3;k.ERROR_PLUGIN_REQUESTCHANNEL_CHANNEL_FULL=k.ep=4;k.ERROR_PLUGIN_SETDATA_CHANNEL_NOT_EXISTED=k.gx=5;k.ERROR_PLUGIN_SETDATA_NOT_OWNER=k.hx=6;k.ERROR_PLUGIN_CLOSECHANNEL_CHANNEL_NOT_EXISTED=k.bx=7;k.ERROR_PLUGIN_CLOSECHANNEL_NOT_OWNER=k.cx=8;k.ERROR_PLUGIN_RECVPRIO_CHANNEL_NOT_EXISTED=k.ex=9;
k.ERROR_PLUGIN_NOT_ENABLED=k.cp=10;k.ERROR_PLUGIN_NOT_ALLOWED=k.bp=11;k.ERROR_PLUGIN_REQUESTCHANNEL_RECORDING_FAILED=k.fx=12;k.ERROR_PLUGIN_OLD_RELAY=k.dx=13;k.TYPE_US_SHORT_MESSAGE2=k.gA=40;k.TYPE_US_SHORT_MESSAGE3=k.hA=41;k.TYPE_US_SHORT_MESSAGE_FAILURE=k.iA=43;k.TYPE_US_ASYMMETRICAL_SHORT_MESSAGE=k.dA=50;k.TYPE_US_SHORT_MESSAGE_OFFLINE=k.jA=60;k.TYPE_US_OFFLINE_MESSAGE2=k.eA=61;k.TYPE_US_OFFLINE_MESSAGE3=k.fA=62;k.IM_TARGET_TYPE_PEER=k.tx=1;k.IM_TARGET_TYPE_GUEST=k.sx=2;
...
16,0),J=q("2",10,0);b.str2bigInt=b.tt=function(b,a,f){return q(b,a,f)};b.powMod=b.PF=function(b,a,f){return H(b,a,f)};b.bigInt2str=b.wj=function(b,a){return D(b,a)};b.createKeyPair=b.rr=function(){var b=q((new r.a.g(r.random.ya(10))).Pb(),16,0),a=H(J,b,w);return{Xh:b,mg:a}};b.createKeyPair_2048=b.sr=function(){var b=q((new r.a.g(r.random.ya(20))).Pb(),16,0),a=H(J,b,Q);return{Xh:b,mg:a}};b.agreeKey=b.br=function(b,a){return H(a,b,w)};b.agreeKey_2048=b.cr=function(b,a){return H(a,b,Q)};b.generateSharedKey=
b.Er=function(b,a,f,d,g,c){c=c||128;var l=r.Id.create(),w=new r.a.g;b=D(b,16);b=r.a.Ic(b);var e;if(b.length<c)for(e=0;e<c-b.length;e++)w.K("\x00");w.K(b);b=D(a,16);b=r.a.Ic(b);if(b.length<c)for(e=0;e<c-b.length;e++)w.K("\x00");w.K(b);b=D(f,16);b=r.a.Ic(b);if(b.length<c)for(e=0;e<c-b.length;e++)w.K("\x00");w.K(b);w.K(d);w.K(g);l.update(w.u());l.update("A");a=l.digest();l.start();l.update(w.u());l.update("B");f=l.digest();l.start();l.update(w.u());l.update(f.u());l=l.digest();f.D(l);return{ja:a.u(),
key:f.u()}}})(window.hmtg);"undefined"===typeof window.hmtg&&(window.hmtg={});
(function(b){function H(){c.localStorage=c.localStorage={};c.localStorage.clear=H}var F=window.W,c=b.util=b.a=b.a||{},y=c.app_id=c.dr=(new F.a.g(F.random.ya(2))).Pb(),h=c.MAX_LOG_ITEM=c.Ip=5E3,q=c.MAX_LOG_SIZE=c.Jp=5E5,E=0,e=Date.now();c.GetTickCount=c.A=function(){if("undefined"===typeof performance||"undefined"===typeof performance.now){var b=Date.now();b<e&&(E+=e-b);e=b;return b+E>>>0}return performance.now()>>>0};c.time=c.time=function(){return Date.now()/1E3>>>0};c.checkBrowser=c.RB=function(){window.File&&
...
r])&&b.length?(t-=b.length,m--,r++,r==d&&(r=0)):t=m=r=0);var A=r+m;for(A>=d&&(A-=d);0!=m&&t+g.length>q;){b=c.localStorage[a+r];if(!b||!b.length){t=m=r=0;break}t-=b.length;m--;r++;r==d&&(r=0)}c.localStorage[a+A]=g;t+=g.length;m++;c.localStorage[e]=r;c.localStorage[h]=m;c.localStorage[p]=t};c.read_hmtg_log=c.QF=function(){var b=c.localStorage.hmtg_log_first_idx>>0,e=c.localStorage.hmtg_log_count>>0;if(e>h||b>=h)return c.Gm(),"";var p=[],t;for(t=0;t<e;t++){var a=b+t;a>=h&&(a-=h);a=c.localStorage["hmtg_log_item_"+
a];if(!a||!a.length)return c.Gm(),"";p.push(a)}return 0==p.length?c.localStorage.hmtg_log:p.join("\n")};c.reset_hmtg_log=c.Gm=function(){c.localStorage.hmtg_log="";c.localStorage.hmtg_log_first_idx=0;c.localStorage.hmtg_log_count=0;c.localStorage.hmtg_log_size=0};c.read_hmtg_log_stat=c.RF=function(){var b=c.localStorage.hmtg_log_stat_first_idx>>0,e=c.localStorage.hmtg_log_stat_count>>0;if(e>h||b>=h)return c.Hm(),"";var p=[],t;for(t=0;t<e;t++){var a=b+t;a>=h&&(a-=h);a=c.localStorage["hmtg_log_stat_item_"+
...
c){var e=0,h=0;if("undefined"!==typeof b.offsetParent){do e+=b.offsetLeft+b.clientLeft,h+=b.offsetTop+b.clientTop;while(b=b.offsetParent)}c.x=e;c.y=h};c.schemeURL=c.UF=function(b){return(b=/^([a-zA-Z][a-zA-Z0-9\+\.\-]*):/.exec(b))&&b[1]?b[1].toLowerCase():""};c.xml_escape=c.Bt=function(b){return b.replace(/\&/g,"&amp;").replace(/\'/g,"&apos;").replace(/\"/g,"&quot;").replace(/\</g,"&lt;").replace(/\>/g,"&gt;")};c.convert32_64=c.or=function(b,c){return 0>b>>0?-(4294967296*((b^4294967295)>>>0)+((c^
...
(function(b){var H=window.W,F=b.m=b.m||{};F.vendor="";F.$F=function(b){for(var c=(new Date).getTime();!((new Date).getTime()-c>b););};F.kg=function(b){if("string"!==typeof b)return{mb:1,Eb:0,gf:0};b=b.split(".");return 2>b.length?{mb:1,Eb:0,gf:0}:3>b.length?{mb:parseInt(b[0].trim()),Eb:parseInt(b[1].trim()),gf:0}:{mb:parseInt(b[0].trim()),Eb:parseInt(b[1].trim()),gf:parseInt(b[2].trim())}};F.Y=function(){};F.I=function(b){b.onopen=b.onclose=b.onerror=b.onmessage=F.Y;b.close()};F.xm=function(c){var y=
...
"mjpg";break;case b.b.Vg:c="vpx";break;default:c="unknown"}return c};F.zj=function(c){var y="",h=1;c&b.b.Vo&&(y+=(h?"":",")+"ACCEPT_GUEST",h=0);c&b.b.Wo&&(y+=(h?"":",")+"END_MEETING",h=0);c&b.b.Pi&&(y+=(h?"":",")+"QUESTION_CONTROL",h=0);c&b.b.Xo&&(y+=(h?"":",")+"POLL",h=0);c&b.b.Hg&&(y+=(h?"":",")+"SYNC",h=0);c&b.b.Qi&&(y+=(h?"":",")+"RETRIEVE_TOKEN",h=0);c&b.b.Si&&(y+=(h?"":",")+"SYNC_TAB",h=0);c&b.b.Ri&&(y+=(h?"":",")+"SYNC_FULLSCREEN");return y};F.ct=function(c){if(40==c.charCodeAt(0)){var y=c.indexOf(")");
if(-1!=y&&1!=y)return b.a.$g(b.a.Ab(c.slice(1,y)),b.b.Ya)}return""};F.Es=function(b){return b.Pd(15)};F.Fs=function(b){return b.Pd(11)};F.Hs=function(b){return b.c(5)};F.Is=function(b){return b.Pd(9)<<16^b.Pd(13)};F.Ah=function(b){return b.Pd(3)};F.Gs=function(b){return b.Pd(1)};F.gd=new Uint8Array(256);F.gd[b.b.sg]=1;F.gd[b.b.wg]=1;F.gd[b.b.tg]=1;F.gd[b.b.vg]=1;F.gd[b.b.lf]=1;F.gd[b.b.xg]=1;F.dC=function(b){return!!F.gd[b]};F.xe=new Uint8Array(256);F.xe[b.b.Rg]=1;F.xe[b.b.Tg]=1;F.xe[b.b.Sg]=1;F.xe[b.b.Ug]=
1;F.xe[b.b.Vg]=1;F.hC=function(b){return!!F.xe[b]};F.et=function(b){return 8+b<<4};F.Rj=function(c){return(c&143)==b.b.Bq};F.ft=function(b){return(b&112)>>4};F.yt=function(c,y,h){var q=y.length;512<q&&(q=512);var E=H.Id.create();E.update(b.crypto.M(y.subarray(0,q),h).u());return E.digest().u()==c}})(window.hmtg);"undefined"===typeof window.hmtg&&(window.hmtg={});
...
p(3);else if(!(d<4+g)){d=H.a.Wg(a.h(4,g));d=b.nc.tt(d,16,0);var e=2048==G?b.nc.cr(aa.Xh,d):b.nc.br(aa.Xh,d);d=b.nc.Er(aa.mg,d,e,c+"."+h,q.tc,2048==G?256:128);q.zc=d;a.shift(4+g);Z=y;0!=a.length()&&Z()}}}function y(){var d=a.length();if(!(4>d)){var g=a.c(0);if(0>g||4096<g)b.a.log("disconnect, incorrect hostkey key"),p(3);else if(!(d<4+g+4)){var c=a.c(4+g);if(0>c||4096<c)b.a.log("disconnect, incorrect hostkey signature"),p(3);else if(!(d<4+g+4+c)){d=a.h(4,g);var h=H.a.oc(d);b.a.log(["hostkey of ",E,
...
p(3);else if(!(d<4+g)){q.tc=a.h(4,g);var c=b.m.kg(q.tc);b.a.log(["server version of ",E,",",e," is ",q.tc].join(""));d=new H.a.g;if(3<c.mb||3==c.mb&&23<c.Eb||3==c.mb&&23==c.Eb&&1<=c.gf){G=2048;d.f(4099);d.f(256);aa=b.nc.sr();c=b.nc.wj(aa.mg,16);var h=H.a.Ic(c);c=256-h.length}else G=1024,d.f(128),aa=b.nc.rr(),c=b.nc.wj(aa.mg,16),h=H.a.Ic(c),c=128-h.length;0!=c&&d.eh(0,c);d.K(h);t.send(d.i());a.shift(4+g);Z=m;0!=a.length()&&Z()}}};v(3);t.send(Y.i());0!=a.length()&&Z();this.stop=function(){ba=!0;B()}};
...
!0,b.m.I(h),y())};var t=new H.a.g("~");t.f(5);t.f(c.Sc);t.f(c.ta);t.f(1);I=function(){var a=q.L(0);q.shift(1);B();A?b.a.log(-1,"alert, jn_MRP_TCPMedia_Notify_relay, should not occur, need investigation, handler_relay_response"):(A=!0,y(),a!=b.b.Dc?e(-1):E())};v();h.send(t.i());0!=q.length()&&I()};c.cs=function(c,h,q,E,e){function y(){p.disconnect=function(){}}function v(){B();m=setTimeout(function(){m=null;b.m.I(h);A?b.a.log(-1,"alert, jn_NotifyMCURelaySessionIndex_relay, should not occur, need investigation, setTimeout"):
...
(B(),A=!0,b.m.I(h),y())};var t=new H.a.g("~");t.f(4);t.f(c.Sc);t.f(c.ta);t.f(c.G);I=function(){var a=q.L(0);q.shift(1);B();if(A)b.a.log(-1,"alert, jn_NotifyMCURelaySessionIndex_relay, should not occur, need investigation, handler_relay_response");else if(A=!0,y(),a!=b.b.Dc){if(0>=a||a>=F.length)a=F.length-1;b.a.log("mcu relay proxy failed, error = "+F[a]);e(-1)}else E()};v();h.send(t.i());0!=q.length()&&I()};c.Ls=function(y,h,q,E,e,D,v,B){function p(){a.disconnect=function(){}}function m(){I();d=
setTimeout(function(){d=null;b.m.I(E);g?b.a.log(-1,"alert, jn_requestslide_relay, should not occur, need investigation, setTimeout"):(g=!0,p(),B())},6E4)}function I(){null!=d&&(clearTimeout(d),d=null)}function A(){g?b.a.log(-1,"alert, jn_requestslide_relay, should not occur, need investigation, normal_disconnect"):(I(),g=!0,b.m.I(E),p())}function t(){var a=e.length(),d=e.L(0);d==b.b.Op?9>a||((a=q.ra=e.c(1),-1==a)?(g=!0,I(),F=b.m.Y,b.m.I(E),p(),B()):(d=e.c(5),q.vj?500<b.a.A()-q.Ba&&(v((d-(a-q.pe))/
...
0!=e.length()&&F()};c.Os=function(y,h,q,E,e){function D(){I.disconnect=function(){}}function v(){B();A=setTimeout(function(){A=null;b.m.I(h);a?b.a.log(-1,"alert, jn_sendslide_relay, should not occur, need investigation, setTimeout"):(a=!0,D(),e())},6E4)}function B(){null!=A&&(clearTimeout(A),A=null)}function p(){a?b.a.log(-1,"alert, jn_sendslide_relay, should not occur, need investigation, normal_disconnect"):(B(),a=!0,b.m.I(h),D())}function m(){q.length();q.L(0)==b.b.Dc?(B(),q.shift(1),a=!0,D(),
...
(function(b){function H(c,q,y,e,D,v,B,p){var h=b.b.Ec-21;if(!(p.length>h||0>q||q>=b.b.Ha)&&c.U[q]){var I=e&32768;e&=32767;var A=c.U[q],t=A.srv,a=b.a.A();t||(t=A.srv={},t.X=0,t.count=0,t.na=0,t.Wc=!1,t.uc=t.Ih=0,t.ia=t.Na=a-1E5);t.type=B;if(t.Wc){if(y==t.uc&&e==t.Ih)return;if(A.Rd!=y||A.nd!=e){var d=y-t.uc;0>d&&(d+=65536);0==d?t.na+=e-t.Ih-1:0<d&&32768>d&&(t.na+=d-1+e+1)}}t.X+=p.length+21;t.count++;1E4<a-t.Na>>>0?(t.ia=a,t.X=0,t.count=0,t.na=0):3E3<a-t.ia&&(t.rate=0,0<t.count&&(t.tick=a,t.rate=8E3*
t.X/(a-t.ia)>>0,c.Ca("video_recv_rate(ssrc "+q+"),"+t.rate)),t.loss_rate=0,0<t.na&&(t.tick=a,t.loss_rate=t.na/(t.na+t.count)*1E4>>0,c.Ca("video_loss_rate(ssrc "+q+"),"+t.loss_rate)),t.ia=a,t.X=0,t.count=0,t.na=0);t.Na=a;t.uc=y;t.Ih=e;t.Wc=!0;if(A.Rd==y)if(A.nd==e)if(0==e&&(A.data=""),A.data+=p,I)A.Rd=y+1&65535,A.nd=0;else{if(p.length!=h)return;A.nd++;return}else{A.Rd=y+1&65535;A.nd=0;return}else if(0==e)if(A.data=p,I)A.Rd=y+1&65535,A.nd=0;else{if(p.length!=h)return;A.Rd=y;A.nd=1;return}else{A.Rd=
...
p){B.Jh=1;v(q);b.a.log("download self picture for ssrc "+q+" fails. total num not match");return}B.Nh.set(b.a.ai(D),500*y);B.Oh+=D.length;B.Kh[y>>3]|=1<<(y&7);B.fg++;B.fg==B.Lh&&(B.Jh=1,v(q),B.fg=0,D=B.Nh.subarray(0,B.Oh),B.Nh=null,h.Jm(q,D,e))}}}}var c=window.W,y=b.protocol=b.protocol||{};y.As=function(h,q,E){function e(b){var e=new c.a.g;if(h.sa){var m=new y.Bs(h,b,e,function(){new D(b,e)},function(b){E(b)});v.disconnect=function(){m.disconnect()}}else new D(b,e)}function D(e,m){if(h.sa)var p=new y.Nb(h.xd,
...
y.Sa=function(h){function q(){p.disconnect=function(){}}function E(){b.a.log("mediatcp is stopped while connecting");I&&(clearTimeout(I),I=null);A&&A.disconnect();q()}function e(){b.$.rj()?(t=!1,A=new y.As(h,v,D),p.disconnect=E):q()}function D(a){A=null;0<a?(m++,60<m&&(m=60),b.a.log("mediatcp: connecting fails, try again..."),I=setTimeout(function(){I=null;e()},1E3*(m+1))):(q(),b.a.log("mediatcp: connecting fails, give up"))}function v(a,d){function g(){P&&(clearInterval(P),P=null)}function r(){z();
...
w+",use "+a+"ms"),p.v.onmessage||(p.v.onmessage=A,p.v.postMessage({command:"set"}))):(w++,v())}}function v(){var l=d.length();if(!(5>l)){var c=d.c(0);if(4293844428==c>>>0&&187==d.L(4))d.shift(5),C();else if(21>=c||25E3<=c)z(),f?b.a.log(-1,"alert, jn_media_tcp_thread/main_loop, should not occur, need investigation, handler"):(b.a.log("mediatcp: break due to illegal recv length: "+c),f=!0,G(),g(),p.v.terminate(),v=b.m.Y,b.m.I(a),x());else if(!(l<c+4)){d.shift(4);if(h.ta==b.m.Es(d)){if(b.m.Rj(d.L(0))){if(29>=
c){d.shift(c);C();return}l=d.h(0,29);var e=b.crypto.w(d.h(29,c-21-8),h.ba).u()}else l=d.h(0,21),e=b.crypto.w(d.h(21,c-21),h.ba).u();var w=l.charCodeAt(0);l=b.m.Fs(d);w==b.b.lf&&2==e.charCodeAt(0)&&(w=b.b.ug);if(w==b.b.tg||w==b.b.ug||w==b.b.xg||w==b.b.sg||w==b.b.wg||w==b.b.vg||w==b.b.lf)a:{var r=b.m.Ah(d),n=w;if(!(0>l||l>=b.b.Ha)&&h.U[l]){var Q=h.U[l];w=Q.sra;var m=b.a.A();w||(w=Q.sra={},w.X=0,w.count=0,w.na=0,w.Wc=!1,w.uc=0,w.ia=w.Na=m-1E5);w.type=n;if(w.Wc){Q=r-w.uc;if(0==Q)break a;0>Q&&(Q+=65536);
1!=Q&&0<Q&&32768>Q&&(w.na+=Q-1)}w.X+=e.length+21;w.count++;1E4<m-w.Na>>>0?(w.ia=m,w.X=0,w.count=0,w.na=0):3E3<m-w.ia&&(w.rate=0,0<w.count&&(w.tick=m,w.rate=8E3*w.X/(m-w.ia)>>0,h.Ca("audio_recv_rate(ssrc "+l+"),"+w.rate)),w.loss_rate=0,0<w.na&&(w.tick=m,w.loss_rate=w.na/(w.na+w.count)*1E4>>0,h.Ca("audio_loss_rate(ssrc "+l+"),"+w.loss_rate)),w.ia=m,w.X=0,w.count=0,w.na=0);w.Na=m;w.uc=r;w.Wc=!0;b.$.cl&&b.$.cl(e,n,l)}}else if(w==b.b.Tg||w==b.b.Sg||w==b.b.Ug||w==b.b.Vg||w==b.b.Rg)H(h,l,b.m.Ah(d),b.m.Gs(d),
b.m.Hs(d),b.m.Is(d),w,e);else if(b.m.Rj(w))a:{if(r=b.m.Ah(d),n=e,e=d.c(25)&65535,!(0>l||l>=b.b.Ha)&&h.U[l]){w=b.m.ft(w);var J=h.U[l];m=J["srp"+w];Q=b.a.A();m||(m=J["srp"+w]={},m.X=0,m.count=0,m.na=0,m.Wc=!1,m.uc=0,m.ia=m.Na=Q-1E5);m.channel=w;if(m.Wc){J=r-m.uc;if(0==J)break a;0>J&&(J+=65536);1!=J&&0<J&&32768>J&&(m.na+=J-1)}m.X+=n.length+21;m.count++;1E4<Q-m.Na>>>0?(m.ia=Q,m.X=0,m.count=0,m.na=0):3E3<Q-m.ia&&(m.rate=0,0<m.count&&(m.tick=Q,m.rate=8E3*m.X/(Q-m.ia)>>0,h.Ca("appdata_recv_rate(channel "+
w+",ssrc "+l+"),"+m.rate)),m.loss_rate=0,0<m.na&&(m.tick=Q,m.loss_rate=m.na/(m.na+m.count)*1E4>>0,h.Ca("appdata_loss_rate(channel "+w+",ssrc "+l+"),"+m.loss_rate)),m.ia=Q,m.X=0,m.count=0,m.na=0);m.Na=Q;m.uc=r;m.Wc=!0;b.$.El&&b.$.El(n,w,l,e)}}else w==b.b.pj?F(h,l,d.c(1),d.c(5),e):b.$.ts(w,l)}d.shift(c);C()}}}function x(){b.$.rj()?(t=!1,J=setTimeout(function(){J=null;e();b.a.log("mediatcp: reconnecting...")},2E3),p.disconnect=function(){clearTimeout(J);G();p.v.terminate();q()}):q()}m=0;b.a.log("mediatcp: enter main loop");
...
d,g){r=Math.min(a,r);if(2E3<d-z||-2>=r)a=h.va,b.$.Kb(r),a!=h.va&&h.Ca("tcp_media_rate_control,worst_command = "+r+",targetrate = "+h.va+",queue="+g+",avg="+(T>>0)),r=1,z=d}var p=this,m=0,I=null,A=null,t=!1;e();b.a.log("mediatcp: connecting...");var a=b.a.A(),d=0;this.pt=function(a){if(!t)return!0;var d=new c.a.g;d.f(a.length());d.K(a.h(0,17));d.K(b.$.Uf(a));d.D(b.crypto.M(a.h(21),h.ba));this.j.send(d.i());this.V();return!0};this.nt=function(a){if(!t)return!0;var d=b.a.A(),e=this.j.bufferedAmount;
g=e;T+=.1*(e-T);e=h.Km;e||(e=h.Km={},e.X=0,e.ia=e.Na=d-1E5);var r=new c.a.g;r.f(a.length());r.K(a.h(0,17));r.K(b.$.Uf(a));r.D(b.crypto.M(a.h(21),h.ba));this.j.send(r.i());e.X+=a.length();1E4<d-e.Na>>>0?(e.ia=d,e.X=0):3E3<d-e.ia&&(e.rate=0,0<e.X&&(e.tick=d,e.rate=8E3*e.X/(d-e.ia)>>0,h.Ca("audio_send_rate2,"+e.rate)),e.ia=d,e.X=0);e.Na=d;this.V();return!0};h.Ba=b.a.A();h.Nd=4*b.b.Ec;h.ha=h.Nd;this.qt=function(e){if(!t)return!0;var r=b.a.A(),m=this.j.bufferedAmount,z=m-g;g=m;T+=.1*(m-T);h.ha+=(r-h.Ba)*
h.va/8E3;h.Ba=r;if(0>h.ha)return!0;m>h.Em?(a=r,d=0):10<d&&1E4<r-a?(B(1,r,m),a=r,d=0):d++;if(m>h.Dm)return B(-2,r,m),e=Math.max(h.Nd,20*h.va/8E3),h.ha>e&&(h.ha=e),!0;m>h.ng&&B(z>h.ng?-2:-1,r,m);m=h.Lm;m||(m=h.Lm={},m.X=0,m.ia=m.Na=r-1E5);z=e.length()-b.b.ic;var p=(z+(b.b.Ec-b.b.ic)-1)/(b.b.Ec-b.b.ic)>>0,q;for(q=0;q<p;q++){if(q==p-1){var v=z%(b.b.Ec-b.b.ic);0==v&&(v=b.b.Ec-b.b.ic)}else v=b.b.Ec-b.b.ic;var C=new c.a.g;C.K(e.h(0,b.b.ic));C.K(e.h(b.b.ic+q*(b.b.Ec-b.b.ic),v));h.ha-=C.length();m.X+=C.length();
v=new c.a.g;v.f(C.length());v.K(C.h(0,1));v.o(q>>8&255|(q==p-1?128:0));v.o(q&255);v.K(C.h(3,14));v.K(b.$.Uf(C));v.D(b.crypto.M(C.h(21),h.ba));this.j.send(v.i())}e=Math.max(h.Nd,20*h.va/8E3);h.ha>e&&(h.ha=e);1E4<r-m.Na>>>0?(m.ia=r,m.X=0):3E3<r-m.ia&&(m.rate=0,0<m.X&&(m.tick=r,m.rate=8E3*m.X/(r-m.ia)>>0,h.Ca("video_send_rate2,"+m.rate)),m.ia=r,m.X=0);m.Na=r;this.V();return!0};this.ot=function(e,r,m,z,p,q){if(!t||0>r)return!0;var v=b.a.A(),C=h.P[r],A=this.j.bufferedAmount,x=A-g;g=A;T+=.1*(A-T);C.ha+=
(v-C.Ba)*C.zb/8E3;C.Ba=v;if(0>C.ha)return!0;A>h.Em?(a=v,d=0):10<d&&1E4<v-a?(B(1,v,A),a=v,d=0):d++;if(A>h.Dm)return B(-2,v,A),e=Math.max(h.Nd,C.yj,20*C.zb/8E3),C.ha>e&&(C.ha=e),!0;A>h.ng&&B(x>h.ng?-2:-1,v,A);A=C.stat;A||(A=C.stat={},A.X=0,A.ia=A.Na=v-1E5);A.channel=r;C.ha-=e.length()+8;A.X+=e.length()+8;x=new c.a.g;x.f(e.length()+8);x.o(b.m.et(r));x.K(e.h(1,16));x.K(b.$.Uf(e));x.f(m);p||(z|=2147483648);q||(z|=1073741824);x.f(z);x.D(b.crypto.M(e.h(21),h.ba));this.j.send(x.i());e=Math.max(h.Nd,C.yj,
20*C.zb/8E3);C.ha>e&&(C.ha=e);1E4<v-A.Na>>>0?(A.ia=v,A.X=0):3E3<v-A.ia&&(A.rate=0,0<A.X&&(A.tick=v,A.rate=8E3*A.X/(v-A.ia)>>0,h.Ca("appdata_send_rate2(channel "+r+"),"+A.rate)),A.ia=v,A.X=0);A.Na=v;this.V();return!0};var T=0,g=0,r=1,z=b.a.A()};y.Jc=function(h){function q(p){var m=new c.a.g,q=new y.bs(h,p,m,function(){new E(p,m)},function(){b.a.log("MRP_TCPMedia_Notify: connection with mcu relay proxy fails");e.disconnect=function(){}});this.disconnect=function(){q.disconnect()}}function E(c,m){var p=
...
(function(b){var H=window.W,F=b.protocol=b.protocol||{};F.Ps=function(c,y,h){var q=this,E=(h.length+499)/500>>0,e=0,D=4E6/(48E3<c.eb?48E3:c.eb)>>0;1E3<D&&(D=1E3);q.fa=new Worker("worker/worker_interval.js");q.fa.onmessage=function(){c.Xk&&(q.fa&&(q.fa.terminate(),q.fa=null),q.disconnect=function(){});var v=b.$.ws(b.b.pj,h.subarray(500*e,500*e+500),y,e|E<<16);b.$.vs(v);e++;e==E&&(e=0)};q.fa.postMessage({command:"set",delay:D});q.disconnect=function(){q.fa&&(q.fa.terminate(),q.fa=null);q.disconnect=
function(){}}};F.Ns=function(b,y,h){function c(){D.disconnect=function(){}}function E(m){var p=new H.a.g;if(b.sa){var q=new F.Os(b,m,p,function(){e(m,p)},function(){c();h()});D.disconnect=function(){q.disconnect();c()}}else e(m,p)}function e(e,p){var m=new H.a.g("S");m.f(b.ta);m.f(b.G);e.send(m.i());var q=new F.Nb(b.cb,b.ea,e,p,function(){c();y(e,p)},function(){c();h()});D.disconnect=function(){q.disconnect();c()}}var D=this;if(b.sa){var v=b.ca.Vb;var B=b.ca.port}else v=b.Z,B=b.ma;var p=new F.ie(v,
B,function(b){E(b)},function(){c();h()});this.disconnect=function(){p.disconnect();c()}};F.Ms=function(c,y,h,q,E,e,D,v){function B(){p.disconnect=function(){}}var p=this,m=null;m=new F.Ns(c,function(m){function A(){t();g=setTimeout(function(){g=null;b.m.I(m);d?b.a.log(-1,"alert, jn_sendslide.main_loop, should not occur, need investigation, setTimeout2"):(d=!0,B(),e())},F?1E4:6E4)}function t(){null!=g&&(clearTimeout(g),g=null)}function a(){p.fa&&(p.fa.terminate(),p.fa=null)}p.j=m;var d=!1,F=!1,g=null;
...
B()}};F.Ks=function(c,y,h,q,E,e){function D(){p.disconnect=function(){}}function v(b){var a=new H.a.g;if(c.sa){var d=new F.Ls(c,y,h,b,a,function(){B(b,a)},function(b){E(b)},function(){D();e()});p.disconnect=function(){d.disconnect();D()}}else B(b,a)}function B(h,a){if(c.sa){if(c.F==b.b.R){var d=new H.a.g("R");d.f(c.ta);d.f(c.G)}else d=new H.a.g("r"),d.f(c.ta),d.f(c.Yf);h.send(d.i());D();q(h,a)}else if(c.F==b.b.R){d=new H.a.g("R");d.f(c.ta);d.f(c.G);h.send(d.i());var m=new F.Nb(c.cb,c.ea,h,a,function(){D();
q(h,a)},function(){D();e()});p.disconnect=function(){m.disconnect();D()}}else c.F==b.b.Fa&&(d=new H.a.g("r"),d.f(c.ta),d.f(c.Yf),h.send(d.i()),m=new F.Nb(c.cb,c.ea,h,a,function(){D();q(h,a)},function(){D();e()}),p.disconnect=function(){m.disconnect();D()})}var p=this;if(c.sa){var m=c.ca.Vb;var I=c.ca.port}else m=c.Z,I=c.ma;var A=new F.ie(m,I,function(b){v(b)},function(){D();e()});this.disconnect=function(){A.disconnect();D()}};F.Js=function(c,y,h,q,E,e){function D(){b.a.log(2,"info, error occurs downloading slide index "+
...
C.xa=1,n();else if(0>a)C.xa=3,l();else{q=!0;Y=b.m.Y;if(!C.data){if(a>b.$.Rh()){C.xa=4;l();return}if(c.wa+a>b.$.Rh())if(h)b.$.jt(y,a);else{l();return}try{C.data=new Uint8Array(a)}catch(ka){C.data=null;C.xa=4;l();return}c.wa+=a;C.ka=C.ka||0;C.ib=C.ib||0}G=n;aa=P;z.V.onmessage=r;z.V.postMessage({command:"set",delay:20});O.vj||(O.pe=0,O.qg=a);d.shift(4);a=d.length();a>C.ra-C.ka?l():a&&(C.data.set(new Uint8Array(d.i()),C.ka),C.ka+=a,d.shift(a))}}};f();0!=d.length()&&(e(),b.a.A(),Y());z.disconnect=function(){x?
b.a.log(-1,"alert, jn_requestslide.main_loop, should not occur, need investigation, disconnect"):(x=!0,g(),e(),m(),z.v.terminate(),b.m.I(a),B())}}function r(){var a=G,d=aa,f=C.ka;C.ka!=C.ra&&(f&=-512);var g=b.a.A(),e;for(e=0;1E6>e;e++){var r=f-C.ib;if(0==r){ba&&d();break}512<r&&(r=512);var h=b.crypto.w(C.data.subarray(C.ib,C.ib+r),c.ba);C.data.set(new Uint8Array(h.i()),C.ib);C.ib+=r;if(C.ib==C.ra){if(c.sa&&!b.m.yt(C.hash,C.data,c.ba)){b.a.log("Alert! mrp slide download index="+y+" has mismatched hash!");
...
20;d=a.slice(f).indexOf("\x00");if(f+d+1!=a.length||5E3<=d)return;F=a.substr(f,d);break;default:return}return{vt:C,ut:x,text:F}}}var d=m.length();if(!(1>d))if(!m.L(0))D.disconnect(),e(),q&&q();else if(!(13>d)){var g=m.c(9);if(0>g||g>=b.b.Ya<<2)t();else if(!(d<13+g+4)){var p=m.c(13+g);if(0>p||p>=b.b.Ya<<1)t();else if(!(d<13+g+4+p+4)){var v=m.c(17+g+p);if(0>v||13334<=v)t();else if(!(d<13+g+4+p+4+v)){var y=m.c(1),B=m.c(5)>>>0,E=b.crypto.w(m.h(13,g),h.B).u(),O=b.crypto.w(m.h(13+g+4,p),h.B).u();d=b.crypto.w(m.h(13+
g+4+p+4,v),h.B).u();g=13+g+4+p+4+v;var C=0,F="",x=0;if(35==d.charCodeAt(0)){if(x=b.b.Ig,p=b.a.Ib(d.slice(1)),12<=p.length){var n=new H.a.g(p);C=n.c(0);n.L(p.length-1)||(d=p.slice(12).indexOf("\x00"),12+d+1==p.length&&(F=""+n.c(8)+"("+p.substr(12,d)+")"))}}else d=a(b.a.Ib(d)),C=d.vt,x=d.ut,F=d.text;c.$j&&c.$j(h,D,y,B,E,O,C,x,F);m.shift(g);A()}}}}};0!=m.length()&&(v(),E=0,g=b.a.A(),B());D.disconnect=function(){a?b.a.log(-1,"alert, check_im.main_loop, should not occur, need investigation, disconnect"):
...
"";if(t){if(z<9+t)return;x=b.crypto.w(q.h(9,t),h.B).u()}B&&!x?c.sk&&c.sk():c.Ok&&c.Ok(h,v,x);q.shift(9+t);v.Da=1;break;case 7:case 8:if(9>z)return;(z=7==t?c.Pr:c.Or)&&z(h,v,q.c(5));q.shift(9);v.Da=1;break;case 9:if(9>z)return;v.ob=q.c(5);c.Wd&&c.Wd(h,v);q.shift(9);break;case 13:if(9>z)return;c.lk&&c.lk(h,v,q.c(5));q.shift(9);v.Da=1;break;default:b.a.log(3,"checkmessage, unknown playback command "+t);y();return}break;case 48:switch(v.fc){case 19:if(6>z)return;if(t=q.c(2)){c.Xd&&c.Xd(h,v,t);q.shift(6);
...
y.prototype._diskquota=function(){return this.Gh};y.prototype._diskusage=function(){return this.Hh};y.prototype._jn_bEnableWebOfficeEx=function(){return this.Hf};y.prototype._jn_bEnableJNRPassword=y.prototype.Vq=function(){return this.Ne};y.prototype._m_bToArchive=function(){return this.sm}})(window.hmtg);"undefined"===typeof window.hmtg&&(window.hmtg={});
(function(b){function H(){return""+a.Gb+"."+a.Hb+"."+a.Fe+" built on 01/15/2020"}function F(){a.zd="";a.km="";a.le="";a.F=b.b.R;a.ID=!1;a.We="";a.GF="";a.DD=!1;a.Qe=!1;a.rh={};a.va=a.Rc=a.eb=a.Xf=1E7;a.Se=0;a.Me=0;a.Uc=0;a.GD=!0;a.fe=-1;a.ED=!1;a.wd=!1;a.LD=!1;a.If=!1;a.ls=!1;a.MD=!1;a.Pe=!1;a.ke=null;a.ag=0;a.$f=0;a.he="";a.Fh=[]}function c(){this.Xc=0}function y(){this.gc="";this.gg=[];this.xa=0}function h(){}function q(){}function E(g,c){function r(e){g[e].Bc=null;g[e].Dd?b.a.log(["joinnet connecting to backup mcu ",
g[e].Z,",",g[e].ma,"..."].join("")):c&&0==e?b.a.log(["joinnet connecting to (switched) primary mcu ",g[e].Z,",",g[e].ma,"..."].join("")):b.a.log(["joinnet connecting to primary mcu ",g[e].Z,",",g[e].ma,"..."].join(""));g[e].Ed=new b.protocol.hm(a.Gb,a.Hb,a,g,e,function(){g[e].qd=!0;if(g[e].Ob)a:{var r;for(r=0;r<g.length;r++){if(!g[r].qd||!g[r].Ob)break a;var z=g[r].Vs;var x=g[r].Ob}y&&(clearTimeout(y),y=null);b.a.log("joinnet connecting to mcu fails");!z&&a.Pe?(d.Oc&&d.Oc(!1),a.pc=!1):a.sa?(b.a.log("using relay fails, clear relay setting and retry connect......"),
...
(a.fe+59)/60>>>0,e=f/60>>>0,l+=" / "+e+":"+("0000"+(f-60*e)).slice(-2));a.xr=l;d.am&&d.am();fa=setTimeout(g,c+200)}function e(){z();la=setTimeout(function(){la=null;if(!a.C||a.pc)ja=0,e();else if(ja++,3<=ja)b.a.log("disconnect, local timeout"),J();else{var f=new t.a.g;f.o(a.yg);f.K("0");P.send(f.i());e()}},2E4)}function z(){null!=la&&(clearTimeout(la),la=null)}function B(){a.v.onmessage&&(a.v.onmessage=null,a.v.postMessage({command:"clear"}))}function G(f){if(l.length()){var d=b.a.A()-pa;20<d||9<=
...
case a.hn:w();break;case a.bd:if(!(5>l.length()))if(g=l.c(1),0<=g&&g<=a.Aq)ta[g]();else b.a.log(["disconnect, unknown playback command [",g,"]"].join("")),J();break;case a.wi:a:if(g=l.length(),!(5>g)){c=l.c(1);if(1==c)d.Gl&&d.Gl(),l.shift(5);else if(2==c){if(13>g)break a;d.Yk&&d.Yk(l.c(5),l.c(9));l.shift(13)}else{b.a.log(["disconnect, unknown tutor command ",c].join(""));J();break a}M=L;G("COMMAND_TUTOR")}break;case a.fn:O();break;case a.Zm:f(0);break;case a.ni:5>l.length()||(g=l.c(1),0<=g&&g<a.aa.length&&
(a.aa[g].Ze=!0,a.aa[g].data&&(a.wa-=a.aa[g].data.length,a.aa[g].data=null),d.Rl&&d.Rl(g)),l.shift(5),M=L,G("COMMAND_DELETE_SLIDE"));break;case a.mi:5>l.length()||(g=l.c(1),0<=g&&g<a.aa.length&&(a.aa[g].gg=[],d.de&&d.de(1,g)),l.shift(5),M=L,G("COMMAND_CLEAR_MARK"));break;case a.an:5>l.length()||(g=l.c(1),d.Ml&&d.Ml(g),l.shift(5),M=L,G("COMMAND_DEFAULT_VIDEO_COMMAND"));break;case a.Ln:a.Zb=!0;l.shift(1);M=L;G("COMMAND_TOKEN_OWNER_NOTIFY");break;case a.ui:a.vb&&(a.vb=!1,d.ms());l.shift(1);M=L;G("COMMAND_SKIP_QUESTION");
...
l.shift(1);M=L;G("COMMAND_SESSION_END");break;default:b.a.log(["disconnect, unknown command[",g,"/0x",g.toString(16),"]"].join("")),J()}}function H(){var b=l.length();if(!(9>b)){var f=l.c(1);if(f==a.on||f==a.nn){if(21>b)return;l.shift(21)}else l.shift(9);M=L;G("Command_MulticastStartAddrEx,"+f)}}function O(){var f;var c=l.length();if(!(2>c)){var e=f=l.L(1);if(48==f){if(a.F!=b.b.$o&&a.F!=b.b.Gq){if(a.F==b.b.R){if(102>c)return;a.G=l.c(2);a.ta=l.c(6);b.a.log(["my ssrc is ",a.G,", session_index is ",
...
a.Ca(["info: meeting session,ssrc=",a.G,",session_index=",a.ta].join(""));c=new t.a.g;c.f(0);c.f(a.G);c.f(a.ta);c.K(a.zc.key);c.K(a.zc.ja);a.ke=c;l.shift(102)}else{if(18>c)return;a.G=-1;a.Yf=l.c(2);a.ta=l.c(6);a.eb=0;c=new t.a.g;c.f(1);c.f(a.Yf);c.f(a.ta);c.K(a.zc.key);c.K(a.zc.ja);a.ke=c;l.shift(18)}a.kF=a.ta;a:{c="hmtg_joinnet_mcu_usage_"+a.Z;f=Date.now();if("undefined"!=typeof b.a.localStorage[c]&&(e=b.a.Yc(b.a.localStorage[c]),"undefined"!==e&&f>e&&108E6>f-e))break a;b.a.localStorage[c]=JSON.stringify(f);
...
a.Kc=new b.protocol.Kc(a));a.FD=!0;a.C=!0;a.pc=!1;a.La=-1;a.ua=-1;a.za=-1;a.xb=-1;a.Te=0;a.Qe=!1;a.ph();a.F==b.b.R&&g();d.$b&&d.$b();d.Ka&&d.Ka(b.b.qp);a.wd&&a.F==b.b.R&&a.Ma&&1<=a.Ma.length&&95!=a.Ma.charCodeAt(0)&&(a.ls=!0)}M=L;G("COMMAND_INITIAL_INFO")}else{f==b.b.kp&&a.F==b.b.R&&a.he&&d.be&&d.be(a.he,"",-1);if(f>b.b.mp||f<b.b.jp)b.a.log("disconnect, COMMAND_INITIAL_INFO return unknown error: "+f),f=b.b.Mg;else if(f==b.b.ap)a.F!=b.b.R?f=b.b.xp:f=b.b.qf+f-256;else{if(f==b.b.Ui){if(10>c)return;f=
...
b.crypto.w(l.h(13,e),a.ba),f.Cd=f.dc.u(),e=0;e<f.dc.length();e++)if(!f.dc.L(e)){f.Cd=f.dc.h(0,e);f.gc=f.dc.h(e+1);var r;for(r=e+1;r<f.dc.length();r++)if(!f.dc.L(r)){f.gc=f.dc.h(e+1,r-(e+1));break}break}f.gc||(f.gc=b.m.ct(f.Db));b.a.endsWith(f.Db,"blank page")&&(f.lh=!0,f.xa=1);f.V&&(f.Db=b.a.$g("[Deleted]"+b.a.Ab(f.Db),b.b.hj));a.fs(f,a.aa.length);f.index=a.aa.length;a.aa.push(f);r=d.jc();a.F==b.b.R&&-1!=r&&r!=a.G&&f.index==a.Lb&&1==f.xa&&(e=new t.a.g,e.o(a.N),e.f(a.Dg),e.f(1),e.f(f.index),e.f(r),
...
g);if(0>r||2048<=r)b.a.log("disconnect, Command_ChatText invalid len"),J();else if(!(e<9+r+c)){e=l.c(5+g);g=b.crypto.w(l.h(9+g,r),a.ba).u();if(d.Aa){var w;b.$.Yq()==b.b.R&&(w=b.a.A()-a.ee>>0);if(f){var h=l.c(13+r);if(2==f){w=l.c(17+r);var n=b.a.or(l.c(25+r),l.c(21+r))}d.Aa(h,-1,e,g,m(h),w,n)}else d.Aa(-1,-1,e,g,0,w)}l.shift(9+r+c);M=L;G("ChatText,"+f)}}}function w(){var a=l.L(0);b.a.log(["not support command[",a,"/0x",a.toString(16),"]"].join(""));J()}function Q(){z();null!=T&&(clearTimeout(T),T=
...
M=new t.a.g,la=null;a.v=new Worker("worker/worker_timeout.js");a.v.onmessage=null;var ha=b.m.Y,ja=0,ka=0,pa=0,T=null,fa=null,ua=[function(){if(!(9>l.length())){a.Vf=l.c(5);if(a.F==b.b.R){v();var f=new t.a.g;f.o(a.N);f.f(a.si);f.f(a.ae?1:0);a.j.send(f.i());a.sa&&(f=new t.a.g,f.o(a.N),f.f(a.Ag),4==a.ca.Jb.length?(f.f(2),f.Cm(a.ca.Jb)):(f.f(3),f.K(a.ca.Jb)),f.ht(),f.Fd(a.ca.port),f.f(a.Sc),a.j.send(f.i()))}else a.F==b.b.Fa&&(v(),f=new t.a.g,f.o(a.bd),f.f(10),f.f(a.ae?1:0),a.j.send(f.i()));l.shift(9);
...
l.shift(13);M=L;G("COMMAND_VIDEOSENDING_STATUS_EX")}},function(){d.Ka&&d.wb(b.b.wp);l.shift(5);M=L;G("COMMAND_UNKNOWN_RECORDING_EX")},function(){var f=l.length();if(!(17>f)){var g=l.c(5);if(1==g){if(21>f)return;g=l.c(9);var c=l.c(13);f=l.c(17);0<=c&&c<b.b.Ha&&d.Hl&&d.Hl(c,g,f);l.shift(21)}else if(0==g){g=l.c(9);c=l.c(13);f=0>g||g>=a.aa.length?b.b.Fq:1==a.aa[g].xa?b.b.oj:0==a.aa[g].xa&&a.Pa&&a.Pa.index==g?b.b.Dq:b.b.Eq;var e=new t.a.g;e.o(a.N);e.f(a.Dg);e.f(1);e.f(g);e.f(c);e.f(f);a.j.send(e.i());
l.shift(17)}else{b.a.log("disconnect, COMMAND_POLL_SLIDEDOWNLOAD_EX invalid command");J();return}M=L;G("COMMAND_POLL_SLIDEDOWNLOAD_EX")}},w,function(){var f=l.length();if(!(9>f)){var g=l.c(5);if(g==a.tq){if(17>f)return;a.Wf=l.c(9);a.Tc=l.c(13);b.a.log(["Participant Channnel, video ",a.Wf,", audio ",a.Tc].join(""));a.Tc=Math.min(a.Tc,b.b.dd);a.Wf=Math.min(a.Wf,b.b.Qb);l.shift(17)}else if(g==a.oq){if(13>f)return;a.Gf=l.c(9);b.a.log(["discussion mode is now ",a.Gf].join(""));l.shift(13)}else if(g==a.nj||
g==a.yq)if(a.F==b.b.Fa){if(17>f)return;l.shift(17)}else a.uh=g==a.nj?!0:!1,l.shift(9);else if(g==a.xq){if(21>f)return;var c=l.c(9);f=l.c(13);g=l.c(17);-1!=f&&g==b.b.rq&&(0>f||f>=b.b.Qb||(a.kb[f]=c));l.shift(21)}else if(g==a.uq||g==a.zq){if(17>f)return;f=l.c(13);0>f||f>=b.b.Qb||(a.kb[f]=-1);l.shift(17)}else if(g==a.De||g==a.qq){if(17>f)return;c=l.c(9);f=l.c(13);0>f||f>=b.b.dd||(g==a.De?b.a.log("user "+c+" becomes a speaker at channel "+f):b.a.log("speaker channel "+f+" is reset"),a.bc[f]=g==a.De?c:
-1,a.F==b.b.R&&a.Uc&&d.Kb(0),c==a.G&&-1!=a.G&&(a.qc=g==a.De,a.qc&&(a.vb=!1)),d.ul&&d.ul(c,g==a.De,f));l.shift(17)}else if(g==a.vq){if(17>f)return;if(l.c(13)){if(21>f)return;c=l.c(17);if(0>c||c>b.b.Ha){b.a.log("disconnect, PARTICIPANT_VIDEO_QUERY_VIEWER invalid count");J();return}if(f<21+c)return;l.shift(21+c)}else l.shift(17)}else{b.a.log("disconnect, COMMAND_PARTICIPANT_VIDEO_EX invalid command");J();return}M=L;G("COMMAND_PARTICIPANT_VIDEO_EX")}},function(){var a=l.length();if(!(9>a)){var f=l.c(5);
if(1==f)d.Pl&&d.Pl(),l.shift(9);else if(2==f){if(17>a)return;d.al&&d.al(l.c(9),l.c(13));l.shift(17)}else{b.a.log(["disconnect, unknown poll command ",f].join(""));J();return}M=L;G("COMMAND_TOKEN_HOLDER_POLL_EX")}},function(){var f=l.length();if(!(9>f)){var g=l.c(5);1==g?(b.a.log("JoinNet is set to use mcu relay, however the MCU doesn't accept mcu relay"),l.shift(9),a.oh.port=0,setTimeout(function(){d.qs();d.us()},0)):2==g?33>f||(f=l.c(9),0<=f&&f<a.aa.length&&(a.aa[f].hash=l.h(13,20),a.aa[f].tm=!0),
...
J();return}if(f<25+g)return;f=b.crypto.w(l.h(25,g),a.ba).u();var c=f.indexOf("__command: dummypassword ");-1!=c&&(f=f.slice(0,c+25)+"*");var e=l.c(5);c=l.c(9);var r=l.c(21),w=b.a.A()-a.ee>>0;d.Aa&&d.Aa(e,c,r,f,m(e),w);l.shift(25+g)}else l.shift(21);M=L;G("COMMAND_PRIVATE_CHAT_TEXT_EX")}},function(){var f=l.length();if(!(9>f)){var g=l.c(5);if(g==a.vn){if(13>f)return;a.xs=l.c(9);l.shift(13)}else if(g==a.un){if(57>f)return;g=l.c(29);if(0>g||g>=b.b.Fb){b.a.log("disconnect, COMMAND_PLUGIN_EX invalid channel");
J();return}a.P[g]=a.P[g]||new q;a.P[g].active=1;a.P[g].bC=0;a.P[g].type=l.c(9);a.P[g].SF=l.c(21);a.P[g].Jr=l.h(37,4)+l.h(43,2)+l.h(47,2)+l.h(49,8);a.P[g].Oj=b.a.mr(a.P[g].Jr);a.P[g].kt=l.c(33);a.P[g].Am=l.c(25);a.P[g].kd=l.c(13);a.P[g].yj=l.c(17)>>>0;a.P[g].YF=0;a.P[g].Mm=null;a.P[g].Ba=b.a.A();a.P[g].ha=a.Nd;0>=a.P[g].kd&&(a.P[g].kd=1);a.P[g].zb=a.P[g].kd;d.Jf&&d.Jf(g);d.Kb(0);var c=a.P[g].Oj;"E5AF1A56-E29C-4BA6-839A-24C2F30EED02"==c?c="Shared Desktop{"+c+"}":"4FC0606A-DA4A-423F-A830-AC5D9853C201"==
c&&(c="Remote Control{"+c+"}");a.Ca("appdata_new_channel,"+g+","+c+",max_rate="+a.P[g].kd+",ssrc="+a.P[g].Am);d.Pf&&d.Pf(0,a.P[g].kt,g);l.shift(57)}else if(g==a.tn){if(17>f)return;g=l.c(9);b.a.log(-2,"appdata channel errorcode="+g);(g==b.b.hp||g==b.b.gp||g==b.b.fp||g==b.b.ep||g==b.b.cp||g==b.b.bp)&&d.Pf&&d.Pf(g,l.c(13),-1);l.shift(17)}else if(g==a.ri){if(17>f)return;g=l.c(9);if(0>g||g>=b.b.Fb){b.a.log("disconnect, COMMAND_PLUGIN_EX invalid channel");J();return}if(!a.P[g].active){b.a.log("disconnect, COMMAND_PLUGIN_EX inactive channel got static data");
...
a.sn){if(21>f)return;c=l.c(17);if(0>c||c>a.Pg){b.a.log("disconnect, COMMAND_PLUGIN_EX invalid size2");J();return}if(f<21+c)return;l.shift(21+c)}else{b.a.log("disconnect, COMMAND_PLUGIN_EX invalid command");J();return}M=L;G("COMMAND_PLUGIN_EX")}},w,w,w,function(){17>l.length()||(a.zF=l.c(5),a.AF=l.c(9),a.BF=l.c(13),l.shift(17),M=L,G("COMMAND_RECORDING_FILEVERSION_EX"))},function(){a.xb=-1;a.La=a.ua=a.za=-1;d.vl&&d.vl();l.shift(5);M=L;G("COMMAND_END_OF_RECORDINGFILE_EX")},function(){b.a.log("warning: server is going to be shut down!");
...
M=L,G("COMMAND_DISABLE_UTF8_EX"))},function(){if(!(9>l.length())){a.ks=l.c(5)&1?!0:!1;b.a.log("The network initialization has finished");for(var f=["audio codec preference [count: ",a.$d.length,"] is:"],g=0;g<a.$d.length;g++){var c=a.$d[g];f.push(" 0x",c.toString(16),"(",b.m.Xg(c),")")}b.a.log(f.join(""));f=["video codec preference [count: ",a.me.length,"] is:"];for(g=0;g<a.me.length;g++)c=a.me[g],f.push(" 0x",c.toString(16),"(",b.m.Xg(c),")");b.a.log(f.join(""));a.ne||b.a.log("webrtc, this MCU doesn't support webrtc, or is not correctly configured, or lacks valid license");
...
function(){var f=l.length();if(!(9>f)){var g=l.c(5);if(0>g||32<g)b.a.log("disconnect, COMMAND_AUDIO_PREFERENCE_EX invalid codec count"),J();else if(!(f<9+4*g)){a.gs=g;a.$d=[];for(f=0;f<g;f++)a.$d.push(l.c(9+4*f));l.shift(9+4*g);M=L;G("COMMAND_AUDIO_PREFERENCE_EX")}}},function(){var f=l.length();if(!(9>f)){var g=l.c(5);if(0>g||32<g)b.a.log("disconnect, COMMAND_VIDEO_PREFERENCE_EX invalid codec count"),J();else if(!(f<9+4*g)){a.Rs=g;a.me=[];for(f=0;f<g;f++)a.me.push(l.c(9+4*f));l.shift(9+4*g);M=L;G("COMMAND_VIDEO_PREFERENCE_EX")}}},
...
d.ql&&d.ql(),l.shift(9),M=L,G("COMMAND_ASSIGN_ASSISTANT_EX"))},function(){var f=l.length();if(!(9>f)){var g=l.c(5);if(0>g||30<=g)b.a.log("disconnect, COMMAND_RECONNECT_NAME_EX invalid len"),J();else if(!(f<9+g+4)){var c=l.c(9+g);0>c||128<=c?(b.a.log("disconnect, COMMAND_RECONNECT_NAME_EX invalid len2"),J()):f<9+g+4+c||(a.he=a.Ch=l.h(9,g),a.Qs=l.h(9+g+4,c),d.be&&d.be(a.Ch,a.Qs,a.G),l.shift(9+g+4+c),M=L,G("COMMAND_RECONNECT_NAME_EX"))}}},function(){13>l.length()||(x(l.c(5),l.c(9)),l.shift(13),M=L,G("COMMAND_FLIP_SLIDE_EX"))},
...
null);a.Sa=new b.protocol.Sa(a)}function B(g,c,d,e,h){if(a.Pa){if(a.Pa.index==g)return;a.Pa.disconnect();a.Pa=null}a.C?a.Pa=new b.protocol.Js(a,g,c,d,e,h):setTimeout(function(){h&&h()},0)}function p(g){if(!a.C||!A())return 1;var c=new t.a.g;c.o(a.N);c.f(a.li);c.f(g?1:0);a.j.send(c.i());b.a.log("request audio "+(g?"On":"Off"))}function m(g){return 0<=g&&g<b.b.Ha&&a.U[g]?a.U[g].Xc:0}function I(){return a.qa||a.Ja||a.qc}function A(){return a.Vf>=a.li?!0:!1}var t=window.W,a={Gb:1,Hb:39,Fe:1,wa:0};b.a.log("hmtg jnkernel version "+
H());var d=b.jnkernel=b.$=b.$||{};d.version=d.version=H;a.bc=new Int32Array(b.b.dd);a.kb=new Int32Array(b.b.Qb);a.P=[];F();a.disconnect=null;a.Ma="";a.pc=!1;a.yF=2;a.Em=5E3;a.ng=2E4;a.Dm=2E5;a.rc=!0;a.ae=!1;a.Nc=!1;a.G=-1;a.Cq=72;a.fn=48;a.cn=65;a.Zm=67;a.zg=68;a.ni=69;a.mi=71;a.Ln=73;a.ui=74;a.oi=75;a.Kd=77;a.An=81;a.En=83;a.Eg=84;a.Nn=85;a.ti=88;a.an=70;a.yg=66;a.wi=116;a.bd=33;a.yo=86;a.hn=118;a.N=122;a.Nt=0;a.bn=1;a.Mn=2;a.yn=3;a.fu=4;a.mu=5;a.cw=6;a.su=7;a.pn=8;a.tu=9;a.eu=10;a.St=11;a.Qt=12;
a.nu=13;a.Pu=14;a.qn=15;a.Qu=16;a.Ju=17;a.Xm=18;a.Ht=19;a.jn=20;a.In=21;a.kn=22;a.dn=23;a.Lt=24;a.bw=25;a.Ku=26;a.Ou=27;a.Nu=28;a.lu=29;a.Hu=30;a.si=31;a.Bn=32;a.xo=33;a.Mu=34;a.Dg=35;a.iu=36;a.nf=37;a.vi=38;a.Ag=39;a.Gu=40;a.Jt=42;a.It=43;a.zn=44;a.Cg=45;a.au=46;a.ju=47;a.Bg=48;a.pu=49;a.Mt=50;a.ru=51;a.rn=52;a.Kt=53;a.uu=54;a.Kn=55;a.Iu=56;a.Cn=57;a.Et=58;a.Tt=59;a.$t=60;a.gu=61;a.Zt=62;a.Hn=63;a.gn=64;a.on=65;a.du=66;a.nn=67;a.cu=68;a.Wt=69;a.Yt=70;a.Gt=71;a.aw=72;a.Vt=73;a.Lu=74;a.Ft=75;a.qu=
76;a.Fn=77;a.Ym=78;a.Xt=79;a.$m=80;a.ln=81;a.Ot=82;a.en=83;a.Gn=84;a.mn=85;a.Ut=86;a.Rt=87;a.bu=88;a.Wm=89;a.ou=90;a.Pt=91;a.hu=92;a.Jn=93;a.li=94;a.dw=95;a.zo=96;a.ew=97;a.Ji=98;a.Gp=98;a.tq=0;a.iz=1;a.nj=2;a.yq=3;a.wq=4;a.xq=5;a.uq=6;a.sq=7;a.zq=8;a.hz=9;a.nq=10;a.pq=11;a.De=12;a.qq=13;a.gz=14;a.fz=15;a.oq=16;a.vq=17;a.xn=1;a.ri=2;a.pi=3;a.un=4;a.tn=5;a.wn=6;a.sn=7;a.vn=8;a.ku=9;a.vz=0;a.sz=1;a.xz=2;a.qz=3;a.pz=4;a.wz=5;a.uz=6;a.rz=7;a.oz=8;a.nz=9;a.Aq=10;a.Pg=65536;a.gj=8192;a.Cu=1;a.Dn=2;a.Du=
3;a.vu=4;a.xu=5;a.wu=6;a.Au=7;a.Bu=8;a.yu=9;a.Eu=10;a.zu=11;a.Fu=12;a.ds=function(b){b=b.split(",");if(2!=b.length)return{};var a=parseInt(b[1].trim());if(!a)return{};b[0]=b[0].trim();if(0==b[0].length)return{};var g=t.a.gr(b[0]);null==g&&(g="");return{Vb:b[0],Jb:g,port:a}};a.Ca=function(g){if(a.F==b.b.R){var c=(new Date).toString().replace(/(GMT.*)/,""),d=b.a.A()-a.ee,e=d>>>0;d>>=0;var h=e;e&2147483648&&(h=-e>>>0);var m=h/1E3/60>>>0;h=m/60>>>0;m=("0000"+(m-60*h)).slice(-2);b.a.sj("hmtg_log_stat",
"hmtg_log_stat_first_idx","hmtg_log_stat_count","hmtg_log_stat_size","hmtg_log_stat_item_",b.a.Ip,b.a.Jp,b.a.dr+":"+c+(e&2147483648?["(-",h,":",m,",",d,") "].join(""):["(",h,":",m,",",d,") "].join(""))+g)}};a.HF=function(g){a.Ca(b.a.Ab(g))};a.Hj=function(){var b;for(b=0;b<a.aa.length;b++)if(!a.aa[b].Ze)return b;return-1};a.vh=function(b,c){c!=b&&d.ce&&d.ce(-1);c==a.G&&-1!=a.G&&b!=c&&(b=d.Mf?d.Mf():-1,-1!=a.Lb&&d.Cb&&d.Cb(1,a.Lb),-1==b?(b=a.Hj(),d.Cb&&d.Cb(0,b),d.wh(b)):d.wh(b))};a.ph=function(){var b;
for(b=0;b<a.aa.length;b++){var c=a.Lc[b];c&&c.data&&(a.wa-=c.data.length);a.Lc[b]=a.aa[b]}a.aa=[]};a.Vk=function(){var b;for(b=0;b<a.Lc.length;b++){var c=a.Lc[b];c.data&&(a.wa-=c.data.length)}a.Lc=[]};a.fs=function(b,c){if(!(b.xa||a.Lc.length<=c)){var g=!1;c=a.Lc[c];c.data&&(c.Ga==b.Ga?c.Db==b.Db||c.Db&&0==c.Db.indexOf("[Deleted]")&&c.Db.slice(9)==b.Db?(b.data=c.data,b.ka=c.ib,b.ib=c.ib,b.ra=c.ra,b.xa=c.xa,b.hash=c.hash,b.Us=c.Us,c.data=null):g=!0:g=!0,g&&a.Vk())}};a.es=function(){d.rs();a.La=-1;
a.ua=-1;a.za=-1;a.xb=-1;b.a.log("reset participant video channel status in jn_PlaybackRestart");var g;for(g=0;g<b.b.dd;g++)a.bc[g]=-1;for(g=0;g<b.b.Qb;g++)a.kb[g]=-1;a.xb=-1;a.La=-1;b.a.log("init controller to -1 (playback restart)");a.rc=!0;a.Nc=!0;g=a.U;for(var c in g)g.hasOwnProperty(c)&&(g[c].Ie=!1,g[c].af=null);a.ph();d.Al&&d.Al()};a.qh=function(){a.lF=b.a.A()};a.Jm=function(g,c,d){function e(a,c){function d(){b.a.log("download self picture for ssrc "+g+" fails. error in loading image")}try{if(5E7<
a.length){d();return}var e=new Blob([a],{type:c});var r=window.URL.createObjectURL(e)}catch(x){d();return}var m=new Image;m.addEventListener("load",function(){window.URL.revokeObjectURL(r);m.width&&m.height?(h&&(h.af=m),b.$.Kl&&b.$.Kl(g),b.a.log("download self picture for ssrc "+g+" completely")):b.a.log("download self picture for ssrc "+g+" fails. zero image size")},!1);m.addEventListener("error",function(){window.URL.revokeObjectURL(r);d()},!1);m.src=r}var h=a.U[g],r="";1==d?(r="image/bmp",(d=b.$.ns())?
...
this.Cd+this.gc+this.Ga};y.prototype._is_active=function(){return a.G==d.jc()&&a.F==b.b.R?!1:this.index==a.Lb};h.prototype._m_iColor=function(){return this.rm};h.prototype._m_iIndex=function(){return this.V};h.prototype._m_iSource=function(){return this.Ga};h.prototype._m_nPenWidth=function(){return this.zm};h.prototype._m_iShape=function(){return this.wt};h.prototype._m_codepage=function(){return this.Xc};h.prototype._m_byMarkType=function(){return this.Gc};h.prototype._ax=function(){return this.Pj};
...
function(){return this.xt};h.prototype._id_array=function(){return this.om};h.prototype._m_iCustomizedMarkType=function(){return this.lt};h.prototype._m_pCustomizedMarkData=function(){return this.zt};q.prototype._guid_str=function(){return this.Oj};q.prototype._active=function(){return this.active};q.prototype._static_data=function(){return this.Mm};q.prototype._stat=function(){return this.stat};q.prototype._data_rate_threshold=function(){return this.kd};q.prototype._jn_tokens=q.prototype.Zq=function(){if(0<
this.ha)return this.ha;var a=b.a.A();this.ha+=(a-this.Ba)*this.zb/8E3;this.Ba=a;return this.ha};q.prototype._data_rate=function(b){if("undefined"===typeof b)return this.zb;a.C&&(this.zb=b,d.Kb(0))};d.jt=function(g,c){function e(g,c){var e=a.aa[g];!e.data||c&&!b.a.endsWith(e.Db,".jzf")||(a.wa-=e.data.length,e.data=null,e.ka=0,e.ib=0,e.xa=0,e.ra=0,d.Sl&&d.Sl(g))}var h=b.$.Rh();if(!(a.wa+c<=h)){var r,m=a.aa.length,p=Math.max(m-1-g,g);for(r=p;0<r;r--){var q=g-r;if(0<=q&&(e(q,!0),a.wa+c<=h))return;q=g+
r;if(q<m&&(e(q,!0),a.wa+c<=h))return}for(r=p;0<r;r--){q=g-r;if(0<=q&&(e(q,!1),a.wa+c<=h))break;q=g+r;if(q<m&&(e(q,!1),a.wa+c<=h))break}}};d.Rh=function(){return d.Yl?1048576*d.Yl():536870912};d._memory_usage=d.KB=function(){return a.wa};d._cipher_name=d.Tq=function(){return a.jd};d._duration_str=d.LA=function(){return a.xr};d._jn_bConnected=d.rj=function(){return a.C};d._jn_bConnecting=d.VA=function(){return a.pc};d._jn_UserArray=d.PA=function(){return a.U};d._jn_ssrc_index=d.AB=function(){return a.G};
d._jn_iSessionIndex=d.tB=function(){return a.ta};d._jn_dwSessionStartTick=d.gB=function(){return a.ee};d._jn_iWorkMode=d.Yq=function(){return a.F};d._jn_szUserID=d.BB=function(){return a.Ma};d._jn_codetype=d.bB=function(){return a.bb};d._jn_opus_preferred_bitrate=d.yB=function(){return a.Te};d._jn_audio_codec_array=d.QA=function(){return a.$d};d._jn_video_codec_array=d.GB=function(){return a.me};d._jn_SlideArray=d.OA=function(){return a.aa};d._jn_iActiveSlideIndex=d.hB=function(){return a.Lb};d._jn_bTokenOwner=
d.aB=function(){return a.Zb};d._jn_bTokenHolder=d.$A=function(){return a.qa};d._jn_bDataSender=d.WA=function(){return a.Ja};d._jn_iSize_w=d.vB=function(){return a.zh};d._jn_iSize_h=d.uB=function(){return a.yh};d._jn_bPreferenceQuestioner=d.Wq=function(){return a.rc};d._jn_iAssistant=d.jB=function(){return a.xb};d._jn_iTokenHolder=d.wB=function(){return a.ua};d._jn_iController=d.kB=function(){return a.La};d._jn_iControlFlag=d.Xq=function(){return a.Mb};d._jn_iDataSender=d.lB=function(){return a.za};
...
d.iB=function(){return a.Rc};d._jn_iMaxBandwidth=d.nB=function(){return a.eb};d._jn_tokens=d.Zq=function(){if(0<a.ha)return a.ha;var g=b.a.A();a.ha+=(g-a.Ba)*a.va/8E3;a.Ba=g;return a.ha};d._jn_auto_download_all=d.SA=function(){return a.hs};d._jn_auto_download_next=d.TA=function(){return a.js};d._jnj_opus_preferred_bitrate=d.JB=function(){return a.Ss};d._stat_video=d.NB=function(){return a.Lm};d._stat_audio=d.MB=function(){return a.Km};d._codec2str=d.KA=function(){return b.m.Xg};d._jn_bPreferenceQuestioner=
d.Wq=function(){return a.rc};d._jn_bPreferenceBothVideo=d.XA=function(){return a.ae};d._jn_bRecvVideo=d.ZA=function(){return a.Nc};d._jn_iMaxParticipantAudio=d.oB=function(){return a.Tc};d._jn_bQuestionRequest=d.YA=function(){return a.vb};d._jn_iControlFlag=d.Xq=function(){return a.Mb};d._jn_conversion_support=d.dB=function(){return a.xh};d._jn_conversion_count=d.cB=function(){return a.Qc};d._jn_disable_upload_file=d.fB=function(){return a.cm};d._jn_disable_save_slide=d.eB=function(){return a.bm};
d._sync_ssrc=d.jc=function(){return a.Mb&b.b.Hg?a.La:a.ua};d._is_sync_ssrc=d.qj=function(){var g=a.Mb&b.b.Hg?a.La:a.ua;return-1!=a.G&&a.G==g};d._q_ssrc=d.Ge=function(){return a.Mb&b.b.Pi?a.La:a.ua};d._fullscreen_ssrc=d.MA=function(){return a.Mb&b.b.Ri?a.La:a.ua};d._tab_ssrc=d.$q=function(){return a.Mb&b.b.Si?a.La:a.ua};d._poll_ssrc=d.LB=function(){return a.Mb&b.b.uw?a.La:a.ua};d._jn_iRecordingStatus=d.sB=function(){return a.dm};d._jn_to_archive=d.DB=function(){return a.lm};d._jn_plugin_data=d.zB=
function(){return a.P};d._has_jnr_password=d.NA=function(){return a.ih};d._jn_bEnableJNRPassword=d.Vq=function(){return a.Ne};d._jn_user_record=d.FB=function(){return a.Fh};d._jn_bAudioCap=d.UA=function(){return a.Mc};d._jn_webrtc_signal_server_url=d.IB=function(){if(!a.ne)return"";var g=b.crypto.ad(a.zc.ja.slice(0,16));g=g.Pb().slice(0,32);var c=b.crypto.ad(a.Im.ja.slice(0,16));c=(""+a.ta+"a"+c.Pb()).slice(0,36);return a.ne+"?peerName="+a.G+"&roomId="+c+"&hash="+g};d._jn_webrtc_check_auth=d.HB=function(g){var c=
...
typeof g)return a.va;a.va!=g&&a.C&&(b.a.log("JoinNet set target rate "+a.va+" -> "+g),a.va=g,d.Kb(0))};d.jn_command_Reset=d.zE=function(){a.F=b.b.R;a.aa=[];a.Lc=[];a.wa=0};d.jn_command_CallbackReady=d.RD=function(){var a=b.$;a.jl=a.jn_callback_ErrorReport;a.ns=a.jn_callback_decompress;a.Yl=a.jn_callback_memory_threshold;a.Xl=a.jn_callback_fail_to_connect;a.Ka=a.jn_callback_UpdateStatus;a.wb=a.jn_callback_UpdateStatus_MessageBox;a.Kf=a.jn_callback_ErrorWrongVersion;a.Oc=a.jn_callback_DisconnectFromMCU;
...
a.zl=a.jn_callback_PlaybackJNRPropertyReady;a.ac=a.jn_callback_IsRecvingAudio;a.Vl=a.jn_callback_WebRTCStatusNotification;a.vl=a.jn_callback_PlaybackEndOfFile};d.jn_command_read_jnj=d.dF=function(c){a.ph();a.Vk();a.qh();var d=c.entries;F();a.Cs=d.portm>>>0;a.Ds=(d.portm2||0)>>>0;a.im=d.ip;a.jm=d.backupip||"";a.zh=d.size_w||320;a.yh=d.size_h||240;8>a.zh&&(a.zh=8);8>a.yh&&(a.yh=8);a.hs=d.auto_download_all;a.js="undefined"===typeof d.auto_download_next?!0:d.auto_download_next>>0;a.Ss="undefined"===typeof d.opus_preferred_bitrate?
0:d.opus_preferred_bitrate>>0;a.We=d.userinfo||"";a.im=d.ip;a.jm=d.backupip||"";var g=a.bb=d.codetype||0;a.oh=a.ds(d.use_relay||"");a.gm=d.make_recording||0;if(0==g)b.a.log("no code type found in .jnj file");else{if(4==g||5==g){a.Ma=a.sc=(d.userid||"").slice(0,127);if(!a.sc)return b.a.log("no userid is specified in .jnj file"),!1;if((c=d.owner_passwd||"")&&b.a.localStorage[c]){var e=b.a.Yc(b.a.localStorage[c]);"undefined"!==e&&e.time&&"string"===typeof e.value&&(e=b.crypto.w(e.value,b.crypto.jf).u(),
...
!1;return!0}if(13==g||15==g){a.We=b.a.hf(d.userinfo||"",b.b.Mp);a.Ma=a.sc=(d.userid||"").slice(0,127);if(0==a.We.length)return b.a.log("no userinfo is specified in .jnj file"),!1;a.le=b.a.hf(d.player_name||"",128);a.le.length&&b.a.oe(["found player_name ",a.le," in jnj"].join(""));15==g?((c=d.owner_passwd||"")&&b.a.localStorage[c]&&(e=b.a.Yc(b.a.localStorage[c]),"undefined"!==e&&e.time&&"string"===typeof e.value&&(e=b.crypto.w(e.value,b.crypto.jf).u(),a.km=e.slice(0,99),b.a.td||b.a.localStorage.removeItem(c))),
a.wd=!0,a.If=!1,a.F=b.b.Fa):(a.If=!0,a.F=d.action?b.b.Fa:b.b.R);a.cc=a.Vc="";return!0}}return!1};d.jn_command_initconnectmedia=d.us=function(c){a.nm=!1;a.C=!1;a.HD=!1;a.Xk=!1;a.Zb=!1;a.qa=!1;a.Ja=!1;a.uh=!1;a.qc=!1;a.Gf=!1;a.vb=!1;a.ee=b.a.A();a.va=a.Rc=a.eb=a.Xf=1E7;a.Se=0;a.Me=0;a.Uc=0;a.G=-1;a.ua=-1;a.za=-1;a.La=-1;a.Mb=0;a.xb=-1;a.Uh=[];for(var g=0;g<b.b.Fb;g++)a.Uh.push({});a.Qe=!1;for(g=0;g<b.b.dd;g++)a.bc[g]=-1;for(g=0;g<b.b.Qb;g++)a.kb[g]=-1;a.U={};a.Gh=-1;a.Hh=-1;a.Te=0;a.Wf=-1;a.Tc=-1;a.ge=
-3;a.Oe=!1;a.xs=-1;a.jF=-2;a.ks=!1;a.Wk=!1;a.em=0;a.fm=0;a.Ne=!1;a.Hf=!1;a.mm=!1;a.cm=a.bm=0;a.gs=0;a.$d=[];a.Rs=0;a.me=[];a.lm=!1;a.ih=!1;a.xh=0;a.Qc=0;a.dm=1;a.$c&&(a.$c.disconnect(),a.$c=null);a.ne="";a.Eh=[];a.Mc=a.vd=!1;d.kl&&d.kl();a.Pe=c||!1;a.KD=!1;a.pc=!0;a.sa=!1;a.oh.port?a.F==b.b.Fa?b.a.log("Warning: mcu relay doesn't support playback, one time mcu relay setting is overruled for this connection"):(a.ca=a.oh,a.sa=!0,b.a.log(["using one time mcu relay ",a.ca.Vb,",",a.ca.port].join(""))):
a.JD&&a.ca.port&&(a.F==b.b.Fa?b.a.log("Warning: mcu relay doesn't support playback, one time mcu relay setting is overruled for this connection"):b.a.log(["using mcu relay ",a.ca.Vb,",",a.ca.port].join("")));a.Vf=0;a.bg=0;g=b.m.Wh(a.im,a.jm,a.Cs,a.Ds);c=g.Ph;g=g.bi;a.gm&&a.sa&&(b.a.log("make recording cannot use relay, clear relay setting and try to directly connect......"),a.sa=!1);E(c,g)};d.jn_command_QuitConnection=d.qs=function(){a.disconnect&&(b.a.log("disconnect, user(or a reconnection) quit connection"),
D())};d.jn_command_OwnerResponse=d.gE=function(b,c){var d=new t.a.g;d.o(a.N);d.f(a.pn);d.H(b);d.f(c);a.j.send(d.i());return 0};d.jn_command_SendChatText=d.AE=function(c,e){if(!a.C)return 1;if(b.a.startsWith(e,"__command:")){if(b.a.startsWith(e,"__command: swap ")){c=e.slice(16);e=c.indexOf(" ");if(-1==e)return d.Aa&&d.Aa(-1,-1,1,"syntax:",0),d.Aa&&d.Aa(-1,-1,1,"__command: swap m n",0),0;d.ss(parseInt(c),parseInt(c.slice(e+1)))}else if(b.a.startsWith(e,"__command: move ")){c=e.slice(16);e=c.indexOf(" ");
if(-1==e)return d.Aa&&d.Aa(-1,-1,1,"syntax:",0),d.Aa&&d.Aa(-1,-1,1,"__command: move index target_pos",0),0;d.os(parseInt(c),parseInt(c.slice(e+1)))}else d.Aa&&d.Aa(-1,-1,1,"list of commands:",0),d.Aa&&d.Aa(-1,-1,1,"__command: swap m n",0),d.Aa&&d.Aa(-1,-1,1,"__command: move index target_pos",0);return 0}if(e.length>=b.b.Kp)return 1;if(-1==c)return a.C?(c=new t.a.g("C"),c.f(e.length),e.length&&c.D(b.crypto.M(e,a.ba)),a.j.send(c.i()),e=0):e=1,e;var g=new t.a.g;g.o(a.N);g.f(a.zn);g.f(c);g.f(e.length);
e.length&&g.D(b.crypto.M(e,a.ba));a.j.send(g.i());return 0};d.jn_command_UpdateTextCodePage=d.TE=function(c){if(!a.C||a.F!=b.b.R)return 1;var d=new t.a.g;d.o(a.N);d.f(a.Kn);d.f(c);a.j.send(d.i());return 0};d.jn_command_WebOfficeSetVisitorName=d.aF=function(b){a.Ue=a.Ve=b};d.jn_command_WebOfficeSetOwnerPassword=d.$E=function(b){a.Ma=a.sc;a.Vc=b;a.cc=a.Vc};d.jn_command_PlaybackPlay=d.mE=function(){if(!a.C||a.F!=b.b.Fa)return 1;var c=new t.a.g;c.o(a.bd);c.f(9);a.j.send(c.i());return 0};d.jn_command_PlaybackPause=
d.lE=function(){if(!a.C||a.F!=b.b.Fa)return 1;var c=new t.a.g;c.o(a.bd);c.f(7);a.j.send(c.i());return 0};d.jn_command_PlaybackRandomAccess=d.nE=function(c){if(!a.C||a.F!=b.b.Fa)return 1;var d=new t.a.g;d.o(a.bd);d.f(8);d.f(c);a.j.send(d.i());a.qh();return 0};d.jn_command_PlaybackRequestRepeat=d.oE=function(c){if(!a.C||a.F!=b.b.Fa)return 1;var d=new t.a.g;d.o(a.bd);d.f(c?6:5);a.j.send(d.i());return 0};d.jn_command_TCPMedia=d.NE=v;d.jn_command_UnknownMedia=d.ts=function(c,e,h){h=h?h:"";if(!a.rh[c+h]){a.rh[c+
h]=!0;b.a.log("unknown media type "+c+h+" from ssrc "+e+", alert user");var g;a.U[e]?g=a.U[e].ci:g="ssrc"+e;d.Ql&&d.Ql(c,g,h)}};d.jn_command_write_timestamp_given=d.ws=function(b,c,d,e){var g=new t.a.g;g.o(b);g.f(e);g.f(d);g.f(a.G);g.f(a.ta);g.f(0);g.D(new t.a.g(c));return g};d.jn_command_generate_auth_data=d.Uf=function(c){var d=b.a.A()-a.cb,g=new t.a.g;g.f(d);d=""+String.fromCharCode(g.L(0)^c.L(4));d+=String.fromCharCode(g.L(1)^c.L(8));d+=String.fromCharCode(g.L(2)^c.L(12));d+=String.fromCharCode(g.L(3)^
c.L(16));return d=b.crypto.M(d,a.ea).u()};d.jn_command_send_audio_pkt=d.eF=function(b){return a.Sa&&d.ys()?a.Sa.nt(b):!0};d.jn_command_send_video_pkt=d.gF=function(b){return a.Sa&&d.zs()?a.Sa.qt(b):!0};d.jn_command_send_plugin_pkt=d.fF=function(b,c,d,e,h,m){return a.Sa?a.Sa.ot(b,c,d,e,h,m):!0};d.jn_command_send_spic_pkt=d.vs=function(b){return a.Sa?a.Sa.pt(b):!0};d.jn_command_AskQuestion=d.OD=function(){if(a.C&&!(a.qa||a.vb||a.qc||a.Ja)){var b=new t.a.g("Q");b.f(a.G);b.f(3);b.K("Yes");a.j.send(b.i());
a.vb=!0}};d.jn_command_simulate_disconnect=d.hF=function(){b.a.log("simulate network disconnection");var c=new t.a.g("H");a.j.send(c.i())};d.jn_command_RefreshSlide=d.vE=function(b){a.C&&(a.Pa&&(a.Pa.disconnect(),a.Pa=null),b=a.aa[b],b.data&&(a.wa-=b.data.length),b.data=null,b.ka=0,b.ib=0,b.xa=0,b.ra=0)};d.jn_command_DownloadSlide=d.WD=function(b,a,c,d){B(b,!1,a,c,d)};d.jn_command_DownloadSlideEx=d.XD=function(b,a,c,d){B(b,!0,a,c,d)};d.jn_command_StopSlideDownload=d.rs=function(){a.Pa&&(a.Pa.disconnect(),
a.Pa=null)};d.jn_command_UploadSlide=d.WE=function(c,d,e,h,m,p,q){a.Ac&&(a.Ac.disconnect(),a.Ac=null);a.C?a.Ac=new b.protocol.Ms(a,c,d,e,h,m,p,q):setTimeout(function(){q&&q()},0)};d.jn_command_StopSlideUpload=d.LE=function(){a.Ac&&(a.Ac.disconnect(),a.Ac=null)};d.jn_command_UploadSelfPicture=d.VE=function(c,d){a.$c||1E6<d.length||(a.$c=new b.protocol.Ps(a,c,d))};d.jn_command_FlipSlide=d.wh=function(b){if(a.C){var c=new t.a.g("A");c.f(b);a.j.send(c.i());-1!=b&&d.ps(b)}};d.jn_command_PollSlideDownload=
d.ps=function(b){d.ce&&setTimeout(function(){d.ce(b)},0);a.Vh&&clearTimeout(a.Vh);a.Vh=setTimeout(function(){a.Vh=null;if(a.C){var c=new t.a.g;c.o(a.N);c.f(a.Dg);c.f(0);c.f(b);a.j.send(c.i())}},1E3)};d.jn_command_FocusPointer=d.$D=function(b,c,d,e,h,m,p){var g=new t.a.g;g.o(a.N);g.f(a.dn);g.f(b);g.f(c);g.f(d);g.f(e);g.f(h);g.f(m);g.f(p);a.j.send(g.i())};d.jn_command_SendNewStroke=d.EE=function(c,d,e,h,m,p){if(a.C){var g=new t.a.g;g.o(a.Kd);g.o(b.b.Ng);g.f(d);g.f(c);g.f(a.G);g.f(e);g.f(h);g.f(m.length);
...
d.DE=function(c,d,e,h,m){if(a.C){var g=new t.a.g;g.o(a.Kd);g.o(b.b.dj);g.f(c);g.f(d);g.f(e);g.f(h);g.f(100);g.f(m.length);for(c=0;c<m.length;c++)g.f(m[c]);b.a.debug_mark_delay?setTimeout(function(){a.j.send(g.i())},1E3*b.a.debug_mark_delay):a.j.send(g.i())}};d.jn_command_SendImageMark=d.CE=function(c,d,e,h,m,p,q,v,y){if(a.C){var g=1==d?8:4;if(5E5<g+v.length)return 1;var r=new t.a.g;r.o(a.Kd);r.o(b.b.cj);r.f(c);r.f(e);r.f(h);r.f(q);r.f(d);r.f(g+v.length);4!=d&&(r.Fd(e+m),r.Fd(h+p));5!=d&&r.Zc(y);r.D(new t.a.g(v));
b.a.debug_mark_delay?setTimeout(function(){a.j.send(r.i())},1E3*b.a.debug_mark_delay):a.j.send(r.i())}};d.jn_command_ConvertCustomizedData=d.TD=function(b,a,c,d,e,h,m){var g=new t.a.g;4!=b&&(g.Fd(a+d),g.Fd(c+e));5!=b&&g.Zc(m);g.D(new t.a.g(h));return g.h(0)};d.jn_command_ChangeCapability=d.SD=function(b,c){!a.C||!!a.sh==!!b&&!!a.th==!!c||(a.Mc=b,a.vd=c,b=new t.a.g,b.o(a.N),b.f(a.Ym),c=0,a.sh=a.Mc,a.th=a.vd,a.Mc&&(c|=1),a.vd&&(c|=2),b.o(c),a.j.send(b.i()))};d.jn_command_AdjustVideoBitrate=d.Kb=function(c){var e,
g=a.va,h=a.Rc,m=a.eb;if(a.Uc){var p=1;a.za!=a.ua&&p++;for(e=0;e<b.b.dd;e++)-1!=a.bc[e]&&p++;m=Math.min(a.Uc/p,m)}m=Math.min(a.Xf+a.Me,m)>>0;a.Rc=m>>0;p=a.va;if(c){g=p;var q=a.va/20;q=Math.max(3E3,q);q+=500*Math.random();p+=q*c>>0;p=Math.max(g>>1,p);p=Math.min(g<<1,p)}p=Math.min(m-a.Me,p);p=Math.max(b.b.Np,p);a.va=p;if(g!=a.va||h!=a.Rc)g!=a.va&&a.C&&(a.Ca("rate control, targetrate "+g+" -> "+a.va),a.F==b.b.R&&b.a.log("rate control, targetrate "+g+" -> "+a.va)),h!=a.Rc&&a.C&&(a.Ca("max bandwidth "+
h+" -> "+a.Rc),a.F==b.b.R&&b.a.log("max bandwidth "+h+" -> "+a.Rc)),d.Rf&&d.Rf();for(e=0;e<b.b.Fb;e++)a.P[e]&&a.P[e].active&&(q=a.P[e].kd/20,q=Math.max(3E3,q),q+=500*Math.random(),p=a.P[e].zb,p+=q*c>>0,g=a.P[e].kd,a.Se&&(g=Math.min(a.Se,g)>>0),p=Math.min(g,p),p=Math.max(1E3,p),p=Math.max(a.P[e].zb>>1,p),p=Math.min(a.P[e].zb<<1,p),a.P[e].zb!=p&&(a.C&&a.Ca("appdata channel "+e+", data rate "+a.P[e].zb+" -> "+p),a.P[e].zb=p,d.Jf&&d.Jf(e)))};d.jn_command_UpdatePreference=d.SE=function(b){if(a.C&&(!b||
!a.rc)&&(b||a.rc)){a.rc=b;var c=new t.a.g;c.o(a.N);c.f(a.yn);c.f(a.G);c.f(b?1:0);a.j.send(c.i())}};d.jn_command_UpdateBothVideoPreference=d.RE=function(c){if(a.C&&(!c||!a.ae)&&(c||a.ae)){a.ae=c;var d=new t.a.g;a.F==b.b.R?(d.o(a.N),d.f(a.si)):(d.o(a.bd),d.f(10));d.f(c?1:0);a.j.send(d.i())}};d.jn_command_RequestVideo=d.yE=function(b){if(a.C&&(!b||!a.Nc)&&(b||a.Nc)){a.Nc=b;var c=new t.a.g;c.o(a.yo);c.f(b?1:0);a.j.send(c.i())}};d.jn_command_ParticipantVideoRequest=d.iE=function(c){for(var d,e=d=-1,g=
0;g<b.b.Qb;g++){if(a.kb[g]==c){d=g;break}-1==a.kb[g]&&(e=g)}if(a.F==b.b.R){if(!a.C)return 1;if(-1!=d)return 0;d=new t.a.g;d.o(a.N);d.f(a.nf);d.f(a.wq);d.f(c);a.j.send(d.i())}else if(a.F==b.b.Fa){if(!a.C)return 1;if(-1!=d)return 0;-1==e&&(d=new t.a.g,d.o(a.N),d.f(a.Bg),d.f(a.kb[0]),d.f(0),a.j.send(d.i()),e=0);d=new t.a.g;d.o(a.N);d.f(a.Bg);d.f(c);d.f(1);a.j.send(d.i());0<=c&&c<b.b.Ha&&(a.kb[e]=c)}return 0};d.jn_command_ParticipantVideoStop=d.jE=function(c){var d;if(!a.C)return 1;var e=-1;for(d=0;d<
b.b.Qb;d++)if(a.kb[d]==c){e=d;break}if(-1==e)return 0;a.F==b.b.R?(d=new t.a.g,d.o(a.N),d.f(a.nf),d.f(a.sq),d.f(c),a.j.send(d.i()),a.kb[e]=-1):a.F==b.b.Fa&&(a.kb[e]=-1,d=new t.a.g,d.o(a.N),d.f(a.Bg),d.f(c),d.f(0),a.j.send(d.i()));return 0};d.jn_command_ParticipantVideoAssignSpeaker=d.hE=function(c){if(!a.C)return 1;if(a.G!=d.Ge())return 0;if(a.F==b.b.R){b.a.log("assign speaker to ssrc "+c);var e=new t.a.g;e.o(a.N);e.f(a.nf);e.f(a.nq);e.f(c);a.j.send(e.i())}return 0};d.jn_command_ParticipantVideoStopSpeaker=
d.kE=function(c){if(!a.C)return 1;var e=d.Ge();if(c!=a.G&&a.G!=e)return 0;a.F==b.b.R&&(b.a.log("stop speaker ssrc "+c),e=new t.a.g,e.o(a.N),e.f(a.nf),e.f(a.pq),e.f(c),a.j.send(e.i()));return 0};d.jn_command_GiveoutToken=d.bE=function(c){if(!a.C)return 1;if(c!=a.G&&!a.qa)return 0;b.a.log("change token to "+c+" - giveout token");var d=new t.a.g;d.o(a.Eg);d.f(c);a.j.send(d.i());return 0};d.jn_command_GiveoutToken2=d.cE=function(c,d){var e;if(!a.C)return 1;if(c!=a.G&&a.qa||!a.qa&&0==a.G&&c==a.G||!a.qa&&
...
(d.length?" with question ["+d.toString()+"]":""))}return 0};d.jn_command_AllowQuestion=d.ND=function(c){if(!a.C)return 1;if(a.G==d.Ge()){var e=new t.a.g;e.o(a.zg);e.f(c);a.j.send(e.i());b.a.log("set datasender to "+c)}return 0};d.jn_command_SkipQuestion=d.KE=function(b){if(!a.C)return 1;if(a.G==d.Ge()){var c=new t.a.g;c.o(a.ui);c.f(b);a.j.send(c.i())}return 0};d.jn_command_EndQuestion=d.YD=function(){if(!a.C)return 1;var b=new t.a.g;b.o(a.zg);b.f(-1);a.j.send(b.i());return 0};d.jn_command_EndQuestionRequest=
d.ZD=function(){if(!a.C)return 1;var b=new t.a.g;b.o(a.N);b.f(a.bn);b.f(a.G);a.j.send(b.i());a.vb=!1;return 0};d.jn_command_Disconnect=d.VD=function(b){if(!a.C)return 1;var c=new t.a.g;c.o(a.oi);c.f(b);a.j.send(c.i());return 0};d.jn_command_BanUserID=d.QD=function(b){if(!a.C||!a.Zb&&a.G!=a.xb)return 1;var c=new t.a.g;c.o(a.N);c.f(a.Xm);c.f(b);a.j.send(c.i());return 0};d.jn_command_SetController=d.HE=function(c){if(!a.C||!a.Zb&&!a.qa&&a.G!=a.La)return 1;var d=new t.a.g;d.o(a.N);d.f(a.$m);d.f(c);a.j.send(d.i());
b.a.log((a.Zb?"owner":a.qa?"holder":"controller")+" change controller to "+c);return 0};d.jn_command_AssignAssistant=d.PD=function(b){if(!a.C||!a.Zb&&a.G!=a.xb)return 1;var c=new t.a.g;c.o(a.N);c.f(a.Wm);c.f(b);a.j.send(c.i());return 0};d.jn_command_TerminateSession=d.OE=function(){if(!a.C)return 1;var b=new t.a.g;b.o(a.ti);a.j.send(b.i());return 0};d.jn_command_SetControlFlag=d.GE=function(c){if(!a.C||!a.Zb&&!a.qa&&a.G!=a.La)return 1;var d=new t.a.g;d.o(a.N);d.f(a.ln);d.f(c);a.j.send(d.i());b.a.log([a.Zb?
"owner":a.qa?"holder":"controller"," change control flag to 0x",c.toString(16),"(",b.m.zj(c),")"].join(""));return 0};d.jn_command_DeleteSlide=d.UD=function(b){if(!a.C)return 1;var c=new t.a.g;c.o(a.ni);c.f(b);a.j.send(c.i());return 0};d.jn_command_SendClearMarking=d.BE=function(c){if(!a.C)return 1;var d=new t.a.g;d.o(a.mi);d.f(c);b.a.debug_mark_delay?setTimeout(function(){a.j.send(d.i())},1E3*b.a.debug_mark_delay):a.j.send(d.i());return 0};d.jn_command_UndoMark=d.QE=function(c){if(!a.C)return 1;
var d=new t.a.g;d.o(a.N);d.f(a.Mn);d.f(a.G);d.f(c);b.a.debug_mark_delay?setTimeout(function(){a.j.send(d.i())},1E3*b.a.debug_mark_delay):a.j.send(d.i());return 0};d.jn_command_GlobalUndoMark=d.dE=function(c,d){if(!a.C)return 1;var e=new t.a.g;e.o(a.Kd);e.K("u");e.f(c);e.f(d);b.a.debug_mark_delay?setTimeout(function(){a.j.send(e.i())},1E3*b.a.debug_mark_delay):a.j.send(e.i());return 0};d.jn_command_PollResult=d.tE=function(b,c){if(!a.C)return 1;var d=new t.a.g;1==b?d.o(a.wi):(d.o(a.N),d.f(a.vi));d.f(2);
d.f(c);a.j.send(d.i());return 0};d.jn_command_TokenHolderPoll=d.PE=function(){if(!a.C)return 1;var b=new t.a.g;b.o(a.N);b.f(a.vi);b.f(1);a.j.send(b.i());return 0};d.jn_command_UserContinue=d.ZE=function(){var b=new t.a.g;b.f(1);a.j.send(b.i())};d.jn_command_UserCancel=d.YE=function(){var c=new t.a.g;c.f(0);a.j.send(c.i());b.a.log("user choose not to continue");setTimeout(function(){D()},1E3)};d.jn_command_JointBrowsingMode=d.fE=function(b){if(!a.C)return 1;var c=new t.a.g;c.o(a.N);c.f(a.kn);c.f(b);
a.j.send(c.i());return 0};d.jn_command_SyncFullScreen=d.ME=function(b,c){if(!a.C)return 1;var d=new t.a.g;d.o(a.N);d.f(a.Hn);d.f(b);d.f(c);a.j.send(d.i());return 0};d.jn_command_ProvidePassword=d.uE=function(c){c=b.crypto.ad(c);var d=new t.a.g;d.f(20);d.D(b.crypto.M(c,a.ea));a.j.send(d.i())};d.jn_command_JointBrowsing=d.eE=function(c,d){if(!(d.length>=b.b.ij)){var e=new t.a.g;e.o(a.N);e.f(a.jn);e.f(c);e.H(d);a.j.send(e.i())}};d.jn_command_ForceSync=d.aE=function(){if(!a.C)return 1;var b=new t.a.g;
b.o(a.N);b.f(a.en);a.j.send(b.i())};d.jn_command_SetRecordingStatus=d.JE=function(b){if(!a.C)return 1;var c=new t.a.g;c.o(a.N);c.f(a.Bn);c.f(b);a.j.send(c.i())};d.jn_command_PlugInSetRecvingPrio=d.rE=function(c,d){if(0>c||c>b.b.Fb||!a.C)return 1;var e=new t.a.g;e.o(a.N);e.f(a.Cg);e.f(a.wn);e.f(c);e.f(d);a.j.send(e.i());a.Ca("appdata_set_recv_prio(channel "+c+") "+d)};d.jn_command_SwapSlide=d.ss=function(b,c){if(!a.C)return 1;var d=new t.a.g;d.o(a.N);d.f(a.Gn);d.f(b);d.f(c);a.j.send(d.i())};d.jn_command_MoveSlide=
d.os=function(b,c){if(!a.C)return 1;var d=new t.a.g;d.o(a.N);d.f(a.mn);d.f(b);d.f(c);a.j.send(d.i())};d.jn_command_RequestPlugInChannel=d.xE=function(c,e,h,m){if(!a.C||a.F!=b.b.R||d.$q()!=a.G)return 1;var g=new t.a.g;g.o(a.N);g.f(a.Cg);g.f(a.xn);g.f(h);g.f(c);g.f(0);g.f(0);g.f(m);g.K(e);a.j.send(g.i())};d.jn_command_PlugInSetStaticData=d.sE=function(c,d){if(0>c||c>b.b.Fb||!a.C||a.F!=b.b.R||d.length>a.Pg)return 1;var e=new t.a.g;e.o(a.N);e.f(a.Cg);e.f(a.ri);e.f(c);e.f(d.length);d.length&&e.D(b.crypto.M(d,
a.ba));a.j.send(e.i())};d.jn_command_PlugInCloseChannel=d.pE=function(c){if(0>c||c>b.b.Fb||!a.C||a.F!=b.b.R||a.P[c].Am!=a.G)return 1;var d=new t.a.g;d.o(a.N);d.f(a.pi);d.f(c);a.j.send(d.i())};d.jn_command_PlugInControlChannelSend=d.qE=function(c,d,e,h,m){if(0>c||c>b.b.Fb||!a.C||m.length>a.gj)return 1;var g=new t.a.g;g.o(a.N);g.f(a.rn);g.f(c);g.f(d);g.f(h);g.f(m.length);m.length&&g.D(b.crypto.M(m,a.ba));g.f(e);a.j.send(g.i())};d.jn_command_SetJNRPassword=d.IE=function(c){if(!a.C||27<c.length)return 1;
var d=new t.a.g;d.o(a.N);d.f(a.gn);d.f(c.length);c.length&&d.D(b.crypto.M(c,a.ba));a.j.send(d.i())};d.jn_command_UpdateVideoSendingStatus=d.UE=function(c){if(!a.C||a.F!=b.b.R)return 1;var d=new t.a.g;d.o(a.N);d.f(a.xo);d.f(c?1:2);a.j.send(d.i())};d.jn_command_UseReconnectName=d.XE=function(b){a.he=b&&12==b.length?b:""};d.jn_command_sipclient_response=d.iF=function(c,d,e){if(!a.C||a.F!=b.b.R)return 1;var g=new t.a.g;g.o(a.N);g.f(a.Cn);g.f(a.Dn);g.f(d.length);d.length&&g.D(b.crypto.M(d,a.ba));g.f(c);
g.f(e);a.j.send(g.i())};d.jn_command_RequestAudio=d.wE=p;d.jn_command_WebRTCStatusNotification=d.cF=function(b){if(!a.C)return 1;var c=new t.a.g;c.o(a.N);c.f(a.zo);c.o(b);a.j.send(c.i())};d.jn_command_WebRTCMediaStatusNotification=d.bF=function(b,c,d){if(!(a.C&&a.Vf>=a.Ji))return 1;var e=new t.a.g;e.o(a.N);e.f(a.Ji);e.o(b);e.f(c);e.o(d);a.j.send(e.i())};d.jn_info_GetUserTextCodePage=d.nF=m;d.jn_info_GetWebOfficeVisitorTargetID=d.pF=function(){return 4!=a.bb||a.je||95!=a.Ma.charCodeAt(0)?"":a.sc};
d.jn_info_GetWebOfficeOwnerTargetID=d.oF=function(){return 5!=a.bb||a.cc?"":a.sc};d.jn_info_IsWOOwnerWrongPassword=d.wF=function(){var b=!a.ke&&5==a.bb&&!a.cc;return!a.ke&&4==a.bb&&!a.je&&95!=a.Ma.charCodeAt(0)&&!a.cc||b?a.Ma:""};d.jn_info_IsSlideSameGroup=d.uF=function(b,c){b=a.aa[b];c=a.aa[c];return b.Cd==c.Cd&&b.gc==c.gc&&b.Ga==c.Ga?!0:!1};d.jn_info_IsSlideDownloading=d.tF=function(){return a.Pa&&-1!=a.Pa.index};d.jn_info_CanSendAudio=d.ys=function(){return a.qa||a.Ja||a.qc||a.Gf};d.jn_info_CanSendVideo=
d.zs=function(){return a.qa||a.Ja||a.qc&&a.uh};d.jn_info_IsTalker=d.vF=I;d.jn_info_CanAddMark=d.mF=function(){return a.Vf>=a.Jn?I()||b.$.qj():a.Ja||a.qc||b.$.qj()};d.jn_info_HasMyPicture=d.qF=function(){return!!a.$c};d.jn_info_joinnet_token_holder_video=d.xF=function(){return!!a.mm};d.jn_info_IsAllQuestionerMeeting=d.rF=function(){return a.Wk};d.jn_info_IsNoAudioSupportedByMCU=d.sF=A})(window.hmtg);"undefined"===typeof window.hmtg&&(window.hmtg={});
(function(b){function H(){return""+x.Gb+"."+x.Hb+"."+x.Fe+" built on 01/15/2020"}function F(){if(!b.a.td){var a=Date.now(),c;for(c in b.a.localStorage)if(b.a.localStorage.hasOwnProperty(c)&&0==c.indexOf("hmtg_temp_autodelete_")){var d=b.a.Yc(b.a.localStorage[c]);("undefined"===d||!d.time||!d.value||6E4<a-d.time)&&b.a.localStorage.removeItem(c)}}}function c(a){y(a);a.J=b.b.Uo;n.T&&n.T(a);a.we=setTimeout(function(){a.we=null;36E3>a.pd&&(a.pd+=a.pd+1);G(a)},1E3*a.pd);b.a.log(6,["schedule to retry connecting ",
...
function p(){for(var a=[],c=0;c<x.la.length;c++){var d=x.la[c],e={};e.office_name=d.Oa;e.homepage=d.ga;e.visitor_folded=d.ye;e.share_file_folded=d.ff;e.event_folded=d.Qd;e.publish_file_folded=d.df;e.pgc_folded=d.re;e.noncontact_folded=d.qe;e.guest=d.S;d.S||(e.last_status=d.eg,e.userid=d.O,(e.saved_password=d.Hd)&&(e.password=b.crypto.M(d.password,b.crypto.jf).u()));a.push(e)}b.a.localStorage.hmtg_wbl=JSON.stringify(a)}function m(b,a,c,d){var f;for(f=0;f<x.la.length;f++){var e=x.la[f];if(e.S==b&&e.ga==
c&&(b||a==e.O)){e.eg=d;break}}}function I(a){a.S&&(a.Tb=1);a.J=b.b.Ao;var f=N.a.bt(a.ga),c=a.Mj=""+b.a.A()+Date.now()+(new N.a.g(N.random.ya(8))).Pb();f&&f.path&&"/raw/"==f.path.toLowerCase()?A(c,a,f.host,"",f.port,0):(n.Wj&&n.Wj(c,a,a.ga,A),a.disconnect=function(){a.Mj=""+b.a.A()+Date.now()+(new N.a.g(N.random.ya(8))).Pb();a.J=b.b.ze;n.T&&n.T(a);b.a.log("sign out for "+a.l)})}function A(a,c,d,e,g,l){a==c.Mj&&(c.disconnect=function(){},"undefined"===typeof d?(c.Ej?n.s&&n.s(c,b.b.Up):n.s&&n.s(c,b.b.Sp),
c.J=b.b.Eo,n.T&&n.T(c),b.a.log(["download jnj fail for ",c.l].join(""))):d&&g?(b.a.log(2,["getmcuinfo for ",c.ga,": ip=",d,",backupip=",e,",port=",g,",port2=",l].join("")),c.Jb=d,c.er=e,c.port=g,c.port2=l,d=b.m.Wh(d,e,g,l),a=d.Ph,d=d.bi,c.J=b.b.Ki,n.T&&n.T(c),t(c,a,d)):(n.s&&n.s(c,b.b.gq),c.J=b.b.Mo,n.T&&n.T(c),b.a.log(["download jnj invalid for ",c.l].join(""))))}function t(f,d,e){function g(a){d[a].Bc=null;d[a].Dd?b.a.log(["msgr connecting to backup mcu ",d[a].Z,",",d[a].ma,"..."].join("")):e&&
0==a?b.a.log(["msgr connecting to (switched) primary mcu ",d[a].Z,",",d[a].ma,"..."].join("")):b.a.log(["msgr connecting to primary mcu ",d[a].Z,",",d[a].ma,"..."].join(""));d[a].Ed=new b.protocol.hm(x.Gb,x.Hb,null,d,a,function(){d[a].qd=!0;d[a].Ob?l():0==a?(r&&(clearTimeout(r),r=null),w(0),p=0,f.J=b.b.Oi,n.T&&n.T(f),new b.protocol.Re(x.Gb,x.Hb,d[0],d[0].Z,d[0].ma,m)):r||h()})}function h(){r=null;var a;for(a=0;a<d.length;a++)if(d[a].qd&&!d[a].Ob){w(a);p=a;f.J=b.b.Oi;n.T&&n.T(f);new b.protocol.Re(x.Gb,
x.Hb,d[a],d[a].Z,d[a].ma,m);break}}function l(){var a;for(a=0;a<d.length;a++)if(!d[a].qd||!d[a].Ob)return;r&&(clearTimeout(r),r=null);f.Je&&n.s&&n.s(f,b.b.Tp);f.J=b.b.Fo;n.T&&n.T(f);f.Fj&&(f.Je=0,c(f),f.disconnect=function(){y(f)})}function w(b){var a;for(a=0;a<d.length;a++)d[a].Bc?(clearTimeout(d[a].Bc),d[a].Bc=null):d[a].qd?a==b||d[a].Ob||d[a].j.close():d[a].Ed&&d[a].Ed.disconnect&&d[a].Ed.disconnect()}function m(c){if(c)1<d.length?(e=0,b.a.log(["connection to mcu ",d[p].Z,",",d[p].ma," fails during key exchange, but we'd like to try other entries"].join("")),
d.splice(p,1),t(f,d,e)):(f.Je&&n.s&&n.s(f,b.b.jj),f.J=b.b.Li,n.T&&n.T(f));else{c=p;var g=d[c].Oe;f.wm=d[c].tc;var l=b.m.kg(f.wm);f.ef=l.mb;f.$h=l.Eb;f.rt=l.gf;f.Xs=d[c].Ye;f.Ws=d[c].Xe;f.jd=d[c].jd;f.B=d[c].ea;f.j=d[c].j;f.Gd=d[c].Gd;f.Z=d[c].Z;f.port=d[c].ma;f.gi=d[c].Dd;c=f.j;if(g){g=new N.a.g("4");c.send(g.i());if(f.gi&&d[0].Z.length){l=b.a.qb(d[0].Z);var h=l.length;g.clear();g.f(4+h);g.f(b.protocol.ii);g.K(l);c.send(g.i())}g.clear();g.f(7);g.f(b.protocol.mf);g.K("WEB");c.send(g.i());b.m.bh&&(g.clear(),
g.f(10),g.f(b.protocol.mf),g.K("NCHOME"),c.send(g.i()));b.m.vendor&&20>=b.m.vendor.length&&(g.clear(),g.f(4+b.m.vendor.length),g.f(b.protocol.ki),g.K(b.m.vendor),c.send(g.i()));g.clear();g.f(0);c.send(g.i())}a(f)}}var p,q;for(q=0;q<d.length;q++)d[q].Bc=setTimeout(g,500*q,q),d[q].Ob=b.b.Mg;var r=setTimeout(h,5E3);f.disconnect=function(){w(-1);f.J=b.b.ze;n.T&&n.T(f);b.a.log("sign out for "+f.l)}}function a(a){function f(){a.v.onmessage||(a.v.onmessage=function(){a.v.onmessage=null;v()},a.v.postMessage({command:"set"}))}
...
a.l))}function K(c){b.m.qm(S,u);m();y(a);p();a.v.terminate();da=b.m.Y;Z(a);a.J=c||b.b.Co;n.T&&n.T(a);b.m.I(a.j);n.zf&&n.zf(a)}function aa(c){if(a.Hc)b.a.log("disconnect() found delayed disconnect in progress for "+a.l);else if(a.Wa||a.xc)b.a.log("disconnect() start delayed disconnect for "+a.l),a.Hc=setTimeout(function(){a.Hc=null;b.a.log("disconnect() execute delayed disconnect for "+a.l);aa(c)},1E3),a.Wa&&(clearTimeout(a.Wa),a.Wa=null,r(a));else return m(),y(a),p(),a.v.terminate(),da=b.m.Y,Z(a),
a.J=c||b.b.ze,n.T&&n.T(a),b.m.I(a.j),b.a.log("sign out for "+a.l),n.zf&&n.zf(a),!0}var ea=a.j;a.Jd=a.kf=!1;var u=a.Gd,R=new N.a.g,S=new N.a.g,na=null;a.v=new Worker("worker/worker_timeout.js");a.v.onmessage=null;var da=b.m.Y,qa=0,sa=0,ma=0,ra=0;a.ei=function(){f()};var va=[function(){var c=u.length();if(!(2>c)){switch(u.L(1)){case b.b.Pq:n.s&&n.s(a,b.b.Zp);a.J=b.b.pf;break;case b.b.Iq:n.s&&n.s(a,b.b.Qp);a.J=b.b.Do;break;case b.b.Rq:n.s&&n.s(a,b.b.bq);a.J=b.b.Ho;break;case b.b.Qq:a.S||(a.cf=1);n.s&&
n.s(a,b.b.$p);a.J=b.b.Go;break;case b.b.Jq:n.s&&n.s(a,b.b.cq);a.J=b.b.Io;break;case b.b.Hq:n.s&&n.s(a,b.b.Rp);a.J=b.b.Bo;break;case b.b.Kq:a.S||(a.cf=1);if(10>c)return;var d=u.c(2),f=u.c(6);if(0>f||1E4<=f){n.s&&n.s(a,b.b.jj);b.a.log("recv error[INIT_INFO,300] for for "+a.l);K(b.b.Li);return}if(c<10+f)return;c=u.h(10,f);n.Ff&&n.Ff(a,d,c);a.J=b.b.Jo;u.shift(8+f);break;case b.b.Oq:n.s&&n.s(a,b.b.fq);a.J=b.b.Ko;break;case b.b.Mq:n.s&&n.s(a,b.b.eq);a.J=b.b.No;break;case b.b.Lq:n.s&&n.s(a,b.b.hq);a.J=b.b.Lo;
break;default:n.s&&n.s(a,b.b.Wy),a.J=b.b.Po}u.shift(2);b.a.log("init info quit for for "+a.l);K(a.J)}},z,function(){n.s&&n.s(a,b.b.iq);u.shift(1);S=R;b.a.log("being overwritten for "+a.l);aa(b.b.Oo)},function(){n.s&&n.s(a,b.b.jq);u.shift(1);S=R;b.a.log("being removed for "+a.l);aa(b.b.Qo)},C,C,C,E,z,z,z,C,C,function(){function c(a,b,c,d){if(a.S||!a.Tb||b==(a.da?a.Qa:a.O))return!1;var f,e=!1;for(f=0;f<a.oa.length;f++){var g=a.oa[f],l;for(l=0;l<g.m_pContactArray.length;l++){var h=g.m_pContactArray[l];
...
e)n.s&&n.s(a,b.b.Ce),b.a.log("wrong userid len[INVITE,800] for "+a.l),K(b.b.Cc);else if(!(c<5+d+4+f+4+e)){c=b.crypto.w(u.h(5,d),a.B).u();var g=u.h(5+d+4,f),h=u.h(5+d+4+f+4,e);n.dk&&n.dk(a,c,h,g);u.shift(5+d+4+f+4+e);S=R;l("COMMAND_US_INVITE")}}}}},C,function(){var c=u.length();if(!(5>c)){var d=u.c(1);a.pg&&!a.S&&3==a.Ta&&a.Ta!=d&&(a.Xa==b.b.Rb&&n.Yr(a.pg,a),a.pg=0);a.Ta=d;if(!a.da&&a.Ta){if(9>c)return;d=u.c(5);if(0>d||1E4<=d){n.s&&n.s(a,b.b.fd);b.a.log("wrong jnj len[OFFICE_STATUS,300] for "+a.l);
K(b.b.cd);return}if(c<9+d)return;a.OF=b.crypto.w(u.h(9,d),a.B).u();u.shift(4+d)}n.T&&n.T(a);u.shift(5);S=R;l("COMMAND_US_OFFICE_STATUS")}},function(){n.as(a,!1);u.shift(1);S=R;l("COMMAND_US_UPDATE_PROFILE")},function(){var c=u.length();if(!(33>c)){a.Ys=u.c(1);a.vr=u.c(5);a.wr=u.c(9);a.LF=u.c(13);a.ym=u.c(17);a.KF=u.c(21);a.NF=u.c(25);var d=u.c(29);if(0>d||128<=d)n.s&&n.s(a,b.b.Ea),b.a.log("wrong username len[VIEW_PROFILE,200] for "+a.l),K(b.b.hb);else if(!(c<33+d+4)){var f=a.username;a.username=u.h(33,
d);var e=u.c(33+d);if(0>e||e>=b.b.Hp)n.s&&n.s(a,b.b.Wp),b.a.log("wrong email len[VIEW_PROFILE,500] for "+a.l),K(b.b.So);else if(!(c<33+d+4+e+8)){a.Zg=u.h(33+d+4,e);var g=u.c(33+d+4+e+4);if(0>g||1E4<=g)n.s&&n.s(a,b.b.fd),b.a.log("recv error[VIEW_PROFILE,900] for "+a.l),K(b.b.cd);else if(!(c<33+d+4+e+8+g)){b.crypto.w(u.h(33+d+4+e+8,g),a.B).u();if(a.da)a.uf=0;else{if(c<33+d+4+e+8+g+4)return;a.uf=u.c(33+d+4+e+8+g);u.shift(4)}a.Bm=1;a.fi||a.ym&&n.fk&&n.fk(a,a.ym);a.fi=1;f!=a.username&&b.Yb.nh(a,a.da?a.Qa:
...
c=c+"."+x.Hb;c=c+"."+x.Fe;c+=a.da?"&type=thirdparty":"&type=weboffice";c+="&mcu_version_string="+a.wm;c+="&mcu_serial="+a.Xs;c+="&mcu_licensesource="+a.Ws;c+="&mcu="+a.Z+","+a.port;c+="&primary_mcu="+(a.gi?"0":"1");c=c+"&sig=web"+("&appurl="+window.location.protocol+"//"+window.location.host+window.location.pathname);b.m.xm(c)}sa=1}a.rg=1;n.T&&n.T(a);n.yk&&n.yk(a);u.shift(1);S=R;l("COMMAND_US_STATUS_INITED")},z,F,F,function(){5>u.length()||(a.st=u.c(1),a.S||(a.cf=0),u.shift(5),S=R,l("COMMAND_US_SIP_CAP"))},
function(){if(!(2>u.length())){if(48==u.L(1)){var a=new N.a.g;a.o(x.xi);a.K("1");ea.send(a.i())}u.shift(2);S=R;l("COMMAND_US_ALIVE")}},function(){a.da=1;n.T&&n.T(a);u.shift(1);S=R;l("COMMAND_US_MMC_FLAG")},function(){var c=u.length();if(!(9>c)){var d=u.c(5);0>d||1E4<=d?(n.s&&n.s(a,b.b.Yp),b.a.log("wrong len[MMC_INTERNAL_ERROR,200] for "+a.l),K(b.b.pf)):c<9+d||((c=u.c(1))&&n.Ff&&n.Ff(a,c,u.h(9,d)),u.shift(9+d),S=R,l("COMMAND_US_MMC_INTERNAL_ERROR"))}},function(){var c=u.length();if(!(5>c)){var d=u.c(1);
0>d||128<=d?(n.s&&n.s(a,b.b.Xp),b.a.log("wrong userid len[MMC_INTERNAL_ID,200] for "+a.l),K(b.b.Cc)):c<5+d+4||(c=u.c(5+d),0>c||128<=c?(n.s&&n.s(a,b.b.Ea),b.a.log("wrong mmc username len[MMC_INTERNAL_ID,500] for "+a.l),K(b.b.hb)):(a.Qa=b.crypto.w(u.h(5,d),a.B).u(),a.MF=b.crypto.w(u.h(5+d+4,c),a.B).u(),u.shift(5+d+4+c),S=R,l("COMMAND_US_MMC_INTERNAL_ID")))}},z,function(){var c=u.length();if(!(13>c)){var d=u.c(9);if(0>d||1E4<=d)n.s&&n.s(a,b.b.fd),b.a.log("wrong jnj len[INVITE_JNJ_GENERATION,200] for "+
a.l),K(b.b.cd);else if(!(c<13+d)){c=u.c(1)>>>0;var f=u.c(5),e=u.h(13,d);!f&&e.length&&(e=b.crypto.w(e,a.B).u());n.bk&&n.bk(a,c,f,e);u.shift(13+d);S=R;l("COMMAND_US_INVITE_JNJ_GENERATION")}}},E,X,function(){var c=u.length();if(!(13>c)){var d=u.c(9);if(0>d||500<=d)n.s&&n.s(a,b.b.aq),b.a.log("wrong jnj len[QUERY_URL_MMC,200] for "+a.l),K(b.b.To);else if(!(c<13+d)){c=u.c(1)>>>0;var f=u.c(5),e=u.h(13,d);0==f&&d&&(e=b.crypto.w(e,a.B).u());n.xk&&n.xk(a,c,f,e);u.shift(13+d);S=R;l("COMMAND_US_QUERY_URL_MMC")}}},
...
0,c);break a}p.splice(m,0,c)}u.shift(16+d+4+g+4+h+4+w+4);e++;e==f&&(da=A,x.Dr||(a.hg=[]),n.Kk&&n.Kk(a));S=R;l("COMMAND_US_UPDATE_EVENT_LIST,2")}}}}}}if(!(9>u.length())){var d=b.crypto.w(u.h(1,8),a.B),f=d.c(0);if(0>f||200<f)b.a.log("too many events in the event list for "+a.l),K();else{a.Zs=d.c(4);a.Ts=b.a.time();u.shift(9);a.hg=[];var e=0;f?da=c:S=R;l("COMMAND_US_UPDATE_EVENT_LIST")}}},z,O,function(){var c=u.length();if(!(5>c)){var f=u.c(1);if(0>f||5E8<=f)n.s&&n.s(a,b.b.Vp),b.a.log("wrong param->guest user id len[GUEST_USER_ID,200] for "+
...
X,O,H,H,z,function(){if(!(5>u.length())){var b=u.c(1);a.Nj=b&1?1:0;a.At=b&2?1:0;a.Ar=b&4?1:0;a.OB=b&8?0:1;a.tj=b&16?1:0;u.shift(5);S=R;l("COMMAND_US_INIT_INFO")}},function(){var c=u.length();if(!(5>c)){var d=u.c(1);if(0>d||128<=d)b.a.log("wrong group id len[CreateGroup 200] for "+a.l),K();else if(!(c<5+d+4)){var f=u.c(5+d);if(0>f||128<=f)b.a.log("wrong peer id len[CreateGroup 500] for "+a.l),K();else if(!(c<5+d+4+f)){if(c=u.h(5,d))if(61!=c.charCodeAt(0))n.ud(a,c);else{var e=u.h(5+d+4,f),g=a.da?a.Qa:
...
for(e=0;e<a.ec.length;e++)g=a.ec[e],d+='<file duration="'+g.duration+'" share_type="'+g.share_type+'" tick="'+g.recv_tick+'" jnj="'+f(g.jnj)+'" username="'+f(g.owner_name)+'" homepage="'+f(g.owner_homepage)+'" title="'+f(g.title),g.read||(d+='" read="'+g.read),g.subject&&(d+='" subject="'+g.subject),d+='"/>\n';d+="</share_file>\n"}d+="</ci>";f=d.length;var n=b.Yb.Sr();500<f&&n?a.xc=new c(d):(e=new N.a.g,e.o(x.yi),e.f(f),f&&e.D(b.crypto.M(d,a.B)),a.j.send(e.i()),b.a.log("save client_info for "+a.l+
": "+f+","+b.a.Ab(d)))}function z(a){a&&a.disconnect&&a.disconnect()}function Z(a){a.kh();a.zr=0;a.gt=0;a.Tb=a.S?1:0;a.TB=0;a.fi=0;a.da=0;a.Nj=0;a.At=0;a.st=0;a.tj=0}function G(a){if(!a.Hc)if(b.a.log("just in case that the existing connection is still alive, prepare to sign out existing connection before reconnection for "+a.l),z(a),Z(a),a.Fj){b.a.log("start quick reconnection for "+a.l);a.disconnect=function(){};var c=b.m.Wh(a.Jb,a.er,a.port,a.port2),d=c.Ph;c=c.bi;a.J=b.b.Ki;n.T&&n.T(a);t(a,d,c)}else b.a.log("start complete reconnection for "+
a.l),a.disconnect=function(){},I(a)}function aa(a,c){b.a.localStorage.hmtg_msgr_g_us_status=JSON.stringify(a);x.ab=a;for(var d=0,f=0;f<x.Ub.length;f++){var e=x.Ub[f];if(!(c&&c!=e||e.S)&&e.Xa!=a&&(d=1,m(e.S,e.O,e.ga,a),e.ah=0,e.Xa=a,e.mh=1,c||(e.pg=0),e.J==b.b.pa)){n.T&&n.T(e);var g=new N.a.g;g.o(x.Ei);g.f(e.Xa);e.j.send(g.i())}}d&&p()}function ba(a,b){if(a.da)return a.Bd[b];a=a.lb;for(var c in a)if(a.hasOwnProperty(c)){var d=a[c];if(d.O==b)return d}return null}function Y(a,c,d,e,g,h,m){a.f(c);d.da?
a.f(h):(a.f(23),a.D(b.crypto.M(g,d.B)));m||e.j.send(a.i())}function X(a,b){return b.S!=a.S||a.ga!=b.ga||!a.S&&a.O!=b.O?!1:!0}function O(a,b){if(!a.S&&b==(a.da?a.Qa:a.O))return!1;for(var c=0;c<a.oa.length;c++)for(var d=a.oa[c],f=0;f<d.m_pContactArray.length;f++)if(b==d.m_pContactArray[f].id)return!0;return!1}function C(a,b){return b==(a.da?a.Qa:a.O)}var N=window.W,x={Gb:1,Hb:25,Fe:0};b.a.log("hmtg jmkernel version "+H());var n=b.jmkernel=b.Yb=b.Yb||{};n.version=n.version=H;x.hv=0;x.Gv=1;x.Av=2;x.Ev=
3;x.Hi=4;x.Fg=5;x.Bi=6;x.mv=7;x.Zn=8;x.Ei=9;x.$n=10;x.uv=11;x.Vu=12;x.Rv=13;x.Tv=14;x.Uu=15;x.Vn=16;x.Rn=17;x.vv=18;x.Xv=19;x.vo=20;x.Kv=21;x.Sv=22;x.zi=23;x.$v=24;x.Gi=25;x.Ov=26;x.xi=27;x.pv=28;x.qv=29;x.rv=30;x.eo=31;x.Ai=32;x.fo=33;x.sv=34;x.Dv=35;x.qo=36;x.Xn=37;x.Ru=38;x.Fv=39;x.ro=40;x.Fi=41;x.ev=42;x.Mv=43;x.Wn=44;x.iv=45;x.fv=46;x.av=47;x.Wv=48;x.co=49;x.Su=50;x.yi=51;x.gv=52;x.lo=53;x.Cv=54;x.po=55;x.Lv=56;x.Yv=57;x.ho=58;x.tv=59;x.Nv=60;x.Ci=61;x.Di=62;x.Hv=63;x.Tu=64;x.Wu=65;x.Xu=66;x.Tn=
67;x.bv=68;x.ao=69;x.ov=70;x.Yn=71;x.jv=72;x.Yu=73;x.lv=74;x.cv=75;x.$u=76;x.Pv=77;x.Qv=78;x.no=79;x.mo=80;x.oo=81;x.Uv=82;x.jo=83;x.uo=84;x.Zv=85;x.Zu=86;x.Un=87;x.dv=88;x.so=89;x.to=90;x.Sn=91;x.kv=92;x.io=93;x.bo=94;x.Qn=95;x.Pn=96;x.Jv=97;x.Iv=98;x.On=99;x.Bv=100;x.ko=101;x.xv=102;x.yv=103;x.wv=104;x.zv=105;x.nv=106;x.wo=107;x.Ii=108;x.Vv=109;x.Fp=109;x.Ub=[];x.la=[];x.ab=b.a.Yc(b.a.localStorage.hmtg_msgr_g_us_status);"undefined"===x.ab&&(x.ab=b.b.Md);x.ab!=b.b.Md&&x.ab!=b.b.kq&&x.ab!=b.b.lq&&
x.ab!=b.b.mj&&x.ab!=b.b.Rb&&(x.ab=b.b.Md);x.Jj=0;x.Dr=!0;x.Y=function(){};E.prototype._g_us_status=function(a){if("undefined"===typeof a)return x.ab;x.ab=a};x.Cr=new E;e.prototype._blocking=function(a){this.Fc&&b.a.log(-1,"alert, _blocking, should not occur, need investigation for "+this.l);this.Fc=!0;this.xj=a};e.prototype._unblocking=function(){this.Fc||b.a.log(-1,"alert, _unblocking, should not occur, need investigation for "+this.l);this.Fc=!1;this.ei&&this.ei()};e.prototype._homepage=function(){return this.ga};
...
n.jm_command_ReadWBL=n.UC=function(){F();x.la=[];var a=[];b.a.localStorage.hmtg_wbl&&"string"===typeof b.a.localStorage.hmtg_wbl&&b.a.localStorage.hmtg_wbl.length&&(a=b.a.Yc(b.a.localStorage.hmtg_wbl),"undefined"===a?a=[]:b.a.isArray(a)||(a=[]));for(var c=0;c<a.length;c++){var d=a[c],e=new v;e.Oa="string"===typeof d.office_name?d.office_name:"";e.ga="string"===typeof d.homepage?d.homepage:"";e.ye=!!d.visitor_folded;e.ff=!!d.share_file_folded;e.Qd=!!d.event_folded;e.df=!!d.publish_file_folded;e.re=
!!d.pgc_folded;e.qe=!!d.noncontact_folded;e.S=!!d.guest;d.guest||(e.eg=d.last_status,e.O="string"===typeof d.userid?d.userid:"",e.Hd=!!d.saved_password,d.saved_password&&(d.password&&"string"===typeof d.password||(d.password=""),e.password=b.crypto.w(d.password,b.crypto.jf).u()));x.la.push(e)}};n.jm_command_WriteWBL=n.Tk=p;n.jm_command_ReorderWBL=n.aD=function(a){var b=[],c,d=!1;for(c=0;c<a.length;c++){var f;a:{for(f=0;f<x.la.length;f++)if(X(a[c].pointer,x.la[f]))break a;f=-1}-1!=f&&(f!=c&&(d=!0),
b.push(x.la[f]))}d&&(x.la=b,n.Tk())};n.jm_command_AddWebOffice=n.lC=function(a,c,d,e,g){var f=0,h;for(h=0;h<x.la.length;h++){var m=x.la[h];if(m.S==c&&m.ga==a&&(c||e==m.O)){f=1;m.nr=1;m.S=c;m.Hd=d;c||(m.O=e,d&&(m.password=g));break}}f||(m=new v,m.nr=1,m.eg=b.b.Md,m.ga=a,m.S=c,!c&&(m.O=e,m.Hd=d)&&(m.password=g),x.la.push(m))};n.jm_command_UpdateWebOfficeLastStatus=n.qD=m;n.jm_command_SignInOffice=n.jD=function(a,c,d,g,h){for(var f=0,m=null,w=0;w<x.Ub.length;w++)if(m=x.Ub[w],m.ga==d&&(a&&m.S||!m.S&&
!a&&m.O==g)){f=1;break}if(f){f=m;if(1E4>f.J){if(f.S)return;if(f.password==h){x.ab=c;f.Xa!=c&&(f.J==b.b.pa?aa(c,f):(f.Xa=c,f.mh=1));return}b.a.log("add office and force existing connection to sign out for "+f.l)}z(f);f.S||(x.ab=f.Xa=c,f.mh=1,f.password=h);f.J=b.b.ze;G(f)}else f=new e,f.Je=!0,f.J=b.b.Ni,f.S=a,f.S||(x.ab=f.Xa=c,f.mh=1,f.O=g,f.password=h,f.username=g),f.ga=d,x.Ub.push(f),f.l=(f.S?"guest":f.O)+" @ homepage "+f.ga,b.a.log(1,["signin, start thread for ",f.l].join("")),n.T&&n.T(f),I(f)};
n.jm_command_SignOutOffice=n.kD=z;n.jm_command_ReconnectOffice=n.VC=G;n.jm_command_RemoveOffice=n.XC=function(a){a&&a.disconnect&&a.disconnect();a&&(a.Va=!0);var b=x.Ub.indexOf(a);-1!=b&&x.Ub.splice(b,1);n.Vj&&n.Vj(a)};n.jm_command_ConnectAllOffice=n.tC=function(a){for(var c=0;c<x.la.length;c++){var d=x.la[c],f=new e;f.J=b.b.Ni;f.S=d.S;f.ye=d.ye;f.ff=d.ff;f.Qd=d.Qd;f.df=d.df;f.re=d.re;f.qe=d.qe;f.Xa=d.eg;f.Oa=d.Oa;f.ga=d.ga;d.S||(f.O=d.O,d.Hd?f.password=d.password:(f.password="",f.cf=1),f.username=
f.O);x.Ub.push(f);f.l=(f.S?"guest":f.O)+" @ homepage "+f.ga;a&&(d.S||d.Hd)?(b.a.log(1,"init, start thread for "+f.l),I(f)):f.J=b.b.ze;n.T&&n.T(f)}};n.jm_command_FindWebOffice=n.DC=function(a){for(var b,c=0;c<x.la.length;c++)if(b=x.la[c],X(a,b))return b;return null};n.jm_command_CreateDummyOffice=n.uC=function(a,b){var c=new e;c.S=!1;c.O=a;c.ga=b;return c};n.jm_command_RemoveWebOffice=n.ZC=function(a){a=x.la.indexOf(a);-1!=a&&x.la.splice(a,1)};n.jm_command_UpdateWebOfficeFoldStatus=n.pD=function(a,
b,c){var d;for(d=0;d<x.la.length;d++){var f=x.la[d];if(X(a,f)){0==b?f.ye=c:2==b?f.qe=c:3==b?f.Qd=c:4==b?f.ff=c:5==b?f.df=c:6==b&&(f.re=c);break}}};n.jm_command_UpdateWebOfficeName=n.$r=function(a){var b;for(b=0;b<x.la.length;b++){var c=x.la[b];if(X(a,c)){c.Oa=a.Oa;break}}};n.jm_command_UpdateWebOfficeProfile=n.rD=function(a){var b;for(b=0;b<x.la.length;b++){var c=x.la[b];if(X(a,c)){c.password=a.password;break}}};n.jm_command_LaunchOffice=n.Wr=function(a){var b=new N.a.g;b.o(x.$n);a.j.send(b.i())};
n.jm_command_AppendDefaultPassword=n.Vr=function(a,c){if(!c)return a;F();var d="hmtg_temp_autodelete_"+(new N.a.g(N.random.ya(20))).Pb();c={time:Date.now(),value:b.crypto.M(c,b.crypto.jf).u()};b.a.localStorage[d]=JSON.stringify(c);a+="\nowner_passwd="+d+"\n";b.a.td||setTimeout(function(){b.a.localStorage.removeItem(d)},6E4);return a};n.jm_command_AppendPlayerName=n.mC=function(a,c){if(c.S)return a;var d=c.username;d?(d+=" @ "+c.ga,d=b.a.hf(d,128)):d="Guest";return a+("\nplayer_name="+d+"\n")};n.jm_command_Base64HashPassword=
n.nC=function(a){var c=b.crypto.ad(a.password);a=b.crypto.M(c,a.B);return b.a.oc(a)};n.jm_command_Visit=n.uD=function(a,c){if(!a.Va&&a.J==b.b.pa){var d=new N.a.g;d.o(x.Zn);d.H(c);a.j.send(d.i());return!0}};n.jm_command_SetStatus=n.Yr=aa;n.jm_command_MMCVisit=n.MC=function(a,c,d,e,g){if(!a.Va&&a.J==b.b.pa){var f=new N.a.g;f.o(x.eo);f.f(c);f.H(d);c=g?1:0;f.f(c);c||f.H(e);a.j.send(f.i());return!0}};n.jm_command_MMCRequestInviteUserJnj=n.LC=function(a,b,c,d,e){var f=new N.a.g;f.o(a==b?x.Xn:x.Ai);f.f(c);
f.H(a==b?d:e);a.j.send(f.i())};n.jm_command_RequestInviteUserJnj=n.bD=function(a,b,c,d){b=new N.a.g;b.o(x.Ai);b.f(c);b.H(d);a.j.send(b.i())};n.jm_command_InviteUser=n.GC=function(a,c,d,e,g){a.Va||!a.Ta&&!a.da||(b.a.oe("inviting user '"+e+"'(name: '"+g+"') @ '"+c.ga+"', invitor '"+(a.da?a.Qa:a.O)+"'(name: '"+a.username+"') @ '"+a.ga+"'"),g=new N.a.g,g.o(x.Vn),g.H(e),g.H(a.ga),g.H(a.da?a.username:a.O),a=d.length,g.f(a),a&&g.D(b.crypto.M(d,c.B)),c.j.send(g.i()))};n.jm_command_InviteGuest=n.FC=function(a,
c,d,e,g){if(!a.Va&&(a.Ta||a.da)){b.a.oe("inviting guest "+g+" @ '"+c.ga+"', invitor '"+(a.da?a.Qa:a.O)+"'(name: '"+a.username+"') @ '"+a.ga+"'");var f=new N.a.g;f.o(x.Wn);f.H(e);f.H(a.ga);f.H(a.da?a.username:a.O);a=d.length;f.f(a);a&&f.D(b.crypto.M(d,c.B));f.H(g);c.j.send(f.i())}};n.jm_command_SendMessage=n.eD=function(a,c,d,e,g,h,m,n){var f=new N.a.g;c?(f.o(x.Tn),f.H(c),m=d.length,f.f(m),m&&f.D(b.crypto.M(d,a.B)),m=e.length,f.f(m),m&&f.D(b.crypto.M(e,a.B))):(c=g||a.S,f.o(c?x.Fi:x.ro),f.H(m),m=d.length,
f.f(m),m&&f.D(b.crypto.M(d,a.B)),m=e.length,f.f(m),m&&f.D(b.crypto.M(e,a.B)),f.H(a.S?a.wf:a.da?a.Qa:a.O),f.H(n),c&&f.H(h));a.j.send(f.i())};n.jm_command_SendWebRTCSignal=n.fD=function(a,c,d){var f=new N.a.g;f.o(x.wo);f.H(d);d=c.length;f.f(d);d&&f.D(b.crypto.M(c,a.B));a.j.send(f.i())};n.jm_command_ParamFindUser=n.Xr=ba;n.jm_command_DownloadServerLog=n.BC=function(a,c,d,e,g,h,m){if(!a.Va&&a.J==b.b.pa){var f=new N.a.g;f.o(x.Qn);f.f(c);f.f(e);f.f(g);f.K(h);f.f(m);f.H(d);a.j.send(f.i());return!0}};n.jm_command_DeleteServerLog=
n.zC=function(a,c,d,e){if(!a.Va&&a.J==b.b.pa){var f=new N.a.g;f.o(x.Pn);f.f(c);f.f(e);f.H(d);a.j.send(f.i());return!0}};n.jm_command_DecodeServerLogLine=n.vC=function(a){var c={};if(35==a.charCodeAt(0)){c.text_type=b.b.Ig;a=b.a.Ib(a.slice(1));var d=new N.a.g(a)}else a=b.a.Ib(a),d=new N.a.g(a),c.text_type=d.c(8);if(d.L(a.length-1))return null;c.tick=d.c(0);var e=12;switch(c.text_type){case b.b.Zi:c.delay=d.c(12),e=16;case b.b.aj:var f=a.slice(e).indexOf("\x00");if(-1==f)return null;d=a.slice(e+f+1).indexOf("\x00");
...
d)return null;c.s1=a.substr(e,f);c.s2=a.substr(e+f+1,d);break;case b.b.$i:case b.b.Yi:c.delay=d.c(12);c.size=d.c(16)>>>0;e=20;f=a.slice(e).indexOf("\x00");if(e+f+1!=a.length||5E3<=f)return null;c.s3=a.substr(e,f);break;case b.b.Ig:f=a.slice(e).indexOf("\x00");if(e+f+1!=a.length||500<=f)return null;c.s3=""+d.c(8)+" ("+a.substr(e,f)+")";break;default:return null}return c};n.jm_command_CheckIM=n.rC=function(a,c,d){return new b.protocol.Ur(a,c,d)};n.jm_command_CheckMsg=n.sC=function(a,c,d){return new b.protocol.Sk(a,
0,d)};n.jm_command_Playback=n.TC=function(a,c,d,e){var f=new N.a.g;a.da?(f.f(1),f.f(e),c.Da=0,c.j.send(f.i())):(f.o(x.lo),f.D(b.crypto.M(d,a.B)),a.j.send(f.i()))};n.jm_command_Delete=n.wC=function(a,b,c,d){var e=new N.a.g;Y(e,2,a,b,c,d)};n.jm_command_MarkRead=n.NC=function(a,b,c,d){var e=new N.a.g;Y(e,6,a,b,c,d)};n.jm_command_MarkUnread=n.OC=function(a,b,c,d){var e=new N.a.g;Y(e,7,a,b,c,d)};n.jm_command_MMCPlaybackSharedFile=n.KC=function(a,c,d){if(!a.Va&&a.J==b.b.pa){var e=new N.a.g;e.o(x.ho);e.f(c);
e.H(d);a.j.send(e.i());return!0}};n.jm_command_MMCEditProfile=n.JC=function(a,c){if(!a.Va&&a.J==b.b.pa){var d=new N.a.g;d.o(x.zi);d.f(c);a.j.send(d.i());return!0}};n.jm_command_JoinEvent=n.IC=function(a,c,d,e,g,h){if(!a.Va&&a.J==b.b.pa){var f=new N.a.g;f.o(x.co);f.f(c);f.H(d);f.H(e);f.f(g?1:0);g||f.H(h);a.j.send(f.i());return!0}};n.jm_command_UpdatePersonalInfo=n.Zr=function(a){var b=new N.a.g;b.o(x.uo);b.H(a.Ua);a.j.send(b.i())};n.jm_command_SpeedupClientInfo=n.lD=function(){var a;for(a=0;a<x.Ub.length;a++){var b=
x.Ub[a];!b.S&&b.Wa&&(clearTimeout(b.Wa),b.Wa=null,r(b))}};n.jm_command_TouchClientInfo=n.Xb=function(a){a.Tb&&!a.Hc&&(a.Wa&&clearTimeout(a.Wa),a.Wa=setTimeout(function(){a.Wa=null;r(a)},6E4))};n.jm_command_RemoveShareFile=n.YC=function(a,b){b=a.ec.indexOf(b);-1!=b&&(a.ec.splice(b,1),n.Xb(a))};n.jm_command_RemoveAllShareFile=n.WC=function(a,b){var c;for(c=a.ec.length-1;0<=c;c--)a.ec[c].group==b&&a.ec.splice(c,1);n.Xb(a)};n.jm_command_UpdateUserInfo=n.Le=function(a,b,c,d){var e;if(a.da){if(e=a.Bd[c])return;
e=new D;a.Bd[c]=e}else{if(e=a.lb[b])return;e=new D;a.lb[b]=e}e.status=0;e.Ta=0;e.mb=0;e.Eb=0;e.O=c;e.username=d;e.Ua=""};n.jm_command_TalkToVisitor=n.mD=function(a,c,d,e){if(!a.Va&&a.J==b.b.pa){var f=new N.a.g;f.o(x.Gi);f.f(c);f.f(d);f.H(e);a.j.send(f.i());return!0}};n.jm_command_SendFileAction=n.dD=function(a,c,d,e,g,h,m){if(!a.Va&&a.J==b.b.pa){var f=new N.a.g;f.o(x.mo);f.f(c);f.f(d);f.f(e);f.f(g);f.f(h);f.H(m);a.j.send(f.i());return!0}};n.jm_command_NotifyFileTransfer=n.PC=function(a,c,d,e,g,h,
m,n,p){if(!a.Va&&a.J==b.b.pa){m&&(c|=2147483648);var f=new N.a.g;f.o(x.io);f.f(c);f.f(d);f.f(g);f.H(h);f.H(e);m&&(f.H(n),f.H(p));a.j.send(f.i());return!0}};n.jm_command_Typing=n.nD=function(a,c,d,e){if(!a.Va&&a.J==b.b.pa){var f=new N.a.g;c?(f.o(x.Un),f.H(c)):(f.o(e?x.to:x.so),f.H(d));a.j.send(f.i());return!0}};n.jm_command_PgcUsernameChange=n.nh=function(a,b){var c=a.fb,d={},e;for(e in c)if(c.hasOwnProperty(e)){var f=a.fb[e];"undefined"!==typeof f.nb[b]&&(q(a,f),d[e]||(n.Ra&&n.Ra(a,e),d[e]=1))}};
n.jm_command_RequestSendFile=n.cD=function(a,c,d,e,g,h,m,n,p){if(!a.Va&&a.J==b.b.pa){var f=new N.a.g;f.o(x.no);f.f(c);f.f(d);f.f(e);f.H(g);f.H(h);m&&(f.H(n),f.H(p));a.j.send(f.i());return!0}};n.jm_command_FileSend=n.CC=function(a,c,d,e,g,h,m){if(!a.Va&&a.J==b.b.pa){var f=d.length;f=f|e<<30|(c?1:0)<<29;c=new N.a.g;c.o(x.oo);c.f(g);c.f(f);c.f(h);c.H(m);c.D(b.crypto.M(d,a.B));a.j.send(c.i());return!0}};n.jm_command_AddPerson=n.kC=function(a,b,c,d){var e=new N.a.g;e.o(b?x.Yn:x.On);e.H(b?b:c);e.H(d);a.j.send(e.i())};
n.jm_command_LeaveGroup=n.ud=function(a,b){var c=new N.a.g;c.o(x.ao);c.H(b);a.j.send(c.i())};n.jm_command_PgcRemove=n.RC=function(a,b){b=b.hh;delete a.fb[b];a.Ad--;n.Ra&&n.Ra(a,b)};n.jm_command_PgcRename=n.SC=function(a,b,c){var d=new N.a.g;d.o(x.ko);d.H(b);d.H(c);a.j.send(d.i())};n.jm_command_ForceLeaveGroup=n.EC=function(a,b,c){var d=new N.a.g;d.o(x.Sn);d.H(b);d.H(c);a.j.send(d.i())};n.jm_command_ViewProfile=n.as=function(a){var b=new N.a.g;b.o(x.vo);b.f(0);a.j.send(b.i())};n.jm_command_Share=n.hD=
function(a,c,d,e,g,h,m,n,p,q){var f=new N.a.g;Y(f,9,a,c,d,e,!0);d=new N.a.g;d.f(m?n:0);m=21;p&&(p=b.crypto.ad(b.a.qb(q)),d.D(p),m=1);for(p=0;p<m;p++)d.o(0);f.D(b.crypto.M(d,a.B));g==a&&h?f.H(h):f.f(0);c.j.send(f.i())};n.jm_command_Unshare=n.oD=function(a,b,c,d){var e=new N.a.g;Y(e,12,a,b,c,d)};n.jm_command_ViewRecord=n.tD=function(a,b,c,d){var e=new N.a.g;Y(e,15,a,b,c,d)};n.jm_command_ChangeTitle=n.qC=function(a,c,d,e,g){var f=new N.a.g;Y(f,11,a,c,d,e,!0);f.f(g.length);g.length&&f.D(b.crypto.M(g,
a.B));c.j.send(f.i())};n.jm_command_ChangeJNRPassword=n.pC=function(a,c,d,e,g,h){var f=new N.a.g;Y(f,10,a,c,d,e,!0);f.f(g.length);g.length&&f.D(b.crypto.M(g,a.B));f.f(h.length);h.length&&f.D(b.crypto.M(h,a.B));c.j.send(f.i())};n.jm_command_ShareFileToUser=n.iD=function(a,c,d,e,g,h,m,n,p,q,r){if(c.J==b.b.pa)return a=new N.a.g,a.o(x.po),a.H(d),a.H(h),a.H(g),a.H(q),a.H(e),a.H(m),a.f(p),a.f(r),a.H(n),c.j.send(a.i()),!0};n.jm_command_ParseViewRecord=n.QC=function(a){var b=new N.a.g(a),c=b.c(12);return 0>
c||128<=c||c+16>a.length?null:[c,b.h(16,c),b.c(0),b.c(8),b.c(4)]};n.jm_command_AddContactGroup=n.jC=function(a,b){var c={},d,e=!1;for(d=0;d<a.oa.length;d++){var f=a.oa[d];if(f.m_szGroupName==b){e=!0;break}else if(b.toLowerCase()<f.m_szGroupName.toLowerCase())break}e||(a.oa.splice(d,0,c),c.m_szGroupName=b,c.contact_folded=0,c.m_pContactArray=[],n.Xb(a))};n.jm_command_RenameContactGroup=n.$C=function(a,b,c){var d,e=!1;for(d=0;d<a.oa.length;d++){var f=a.oa[d];if(f==b){a.oa.splice(d,1);e=!0;break}}if(e){b.m_szGroupName=
c;e=!1;for(d=0;d<a.oa.length;d++)if(f=a.oa[d],f.m_szGroupName==c){e=!0;break}else if(c.toLowerCase()<f.m_szGroupName.toLowerCase())break;e||(a.oa.splice(d,0,b),n.Xb(a))}};n.jm_command_DeleteContactGroup=n.yC=function(a,b){var c,d=!1;for(c=0;c<a.oa.length;c++)if(a.oa[c]==b){a.oa.splice(c,1);d=!0;break}d&&n.Xb(a)};n.jm_command_AddContact=n.iC=function(a,b,c,d){var e={},f,g=!1;for(f=0;f<b.m_pContactArray.length;f++)if(c==b.m_pContactArray[f].id){g=!0;break}else if(c<b.m_pContactArray[f].id)break;g||
(b.m_pContactArray.splice(f,0,e),e.id=c,(b=ba(a,c))?(e.name=b.username||d,e.pm=b.Ua):(e.name=d,e.pm=""),n.Xb(a))};n.jm_command_DeleteContact=n.xC=function(a,b,c){var d,e=!1;for(d=0;d<b.m_pContactArray.length;d++)if(c==b.m_pContactArray[d].id){b.m_pContactArray.splice(d,1);e=!0;break}else if(c<b.m_pContactArray[d].id)break;e&&n.Xb(a)};n.jm_command_SetGroup=n.gD=function(a,b,c,d,e){var f=new N.a.g;Y(f,16,a,b,c,d,!0);f.H(e);b.j.send(f.i())};n.jm_command_Jeditor=n.HC=function(a,b,c,d,e){b.fc=17;var f=
new N.a.g;Y(f,17,a,b,c,d,!0);f.H(e);b.j.send(f.i())};n.jm_command_Download=n.AC=function(a,b,c,d){b.fc=18;var e=new N.a.g;Y(e,18,a,b,c,d,!0);b.j.send(e.i())};n.jm_command_Upload=n.sD=function(a,c,d){function e(){if(1E4<c.Ia&&!c.rf&&c.kc+c.Sb<d.size){var e=Math.min(d.size,c.kc+c.Ia+2E4),f=new FileReader;f.onload=function(a){c.buffer&&(c.buffer.set(c.buffer.slice(c.Ia,c.Sb)),c.buffer.set(new Uint8Array(a.target.result),c.Sb-c.Ia),c.Sb=c.Sb-c.Ia+a.target.result.byteLength,c.kc+=c.Ia,c.Ia=0,c.rf=!1)};
f.onerror=function(){c.buffer&&(c.buffer=null,c.fa&&(c.fa.terminate(),c.fa=null),n.Xd&&n.Xd(a,c,b.b.Sq))};f.readAsArrayBuffer(d.slice(c.kc+c.Sb,e));c.rf=!0}}c.fc=19;var f=new N.a.g;f.f(c.fc);f.f(d.size>>>0);f.f(d.size/4294967296>>>0);f.D(b.crypto.M(c.buffer.slice(0,74),a.B));c.Ia=74;c.j.send(f.i());c.fa=new Worker("worker/worker_interval.js");c.fa.onmessage=function(){if(a.J!=b.b.pa||!c.connected||1!=c.j.readyState)c.connected&&1==c.j.readyState&&c.j.close(),c.ob=0,c.buffer=null,c.fa&&(c.fa.terminate(),
c.fa=null);else if(!c.j.bufferedAmount){var l=b.a.A();if(n.Wd&&500<l-g){var m=(c.kc+c.Ia)/d.size*100>>>0;m!=h&&(h=m,c.ob=m,n.Wd(a,c));g=l}for(m=0;100>m;m++){if(512>c.Sb-c.Ia&&c.Sb+c.kc!=d.size){e();break}var p=Math.min(512,c.Sb-c.Ia);var q=c.buffer.subarray(c.Ia,c.Ia+p);c.Ia+=p;f.clear();f.D(b.crypto.M(q,a.B));c.j.send(f.i());if(c.Ia+c.kc==d.size){c.buffer=null;c.fa&&(c.fa.terminate(),c.fa=null);break}if(20<b.a.A()-l){e();break}}}};c.fa.postMessage({command:"set",delay:10});var g=b.a.A()-1E3,h=0};
n.jm_command_WriteUserProfile=n.vD=function(a){if(a.J==b.b.pa){var c=new N.a.g;c.o(x.zi);c.H(a.username);c.H(a.Zg);var d=a.password?a.password.length:0;c.f(d);d&&c.D(b.crypto.M(a.password,a.B));c.f(a.uf);a.j.send(c.i());return!0}};n.jm_info_GlobalPointer=n.zD=function(){return x.Cr};n.jm_info_TestSameOffice=n.CD=X;n.jm_info_HaveNonContact=n.AD=function(a){if(a.da){var c=a.Bd;for(var d in c)if(c.hasOwnProperty(d)){var e=c[d];if((e.status||e.Ta)&&(e.status!=b.b.Rb||e.O==a.Qa)&&a.Qa!=e.O&&!O(a,e.O))return!0}}else for(d in c=
a.lb,c)if(c.hasOwnProperty(d)&&(e=c[d],(e.status||e.Ta)&&(e.status!=b.b.Rb||e.O==a.O)&&a.O!=e.O&&!O(a,e.O)))return!0;return!1};n.jm_info_IsContact=n.BD=O;n.jm_info_CanTargetUserAcceptInvitation=n.wD=function(a,c){return(a=ba(a,c))&&a.status!=b.b.Rb&&0!=a.status&&1<=a.mb?!0:!1};n.jm_info_CheckSelf=n.xD=C;n.jm_info_GetUserName=n.Uk=function(a,b){if(C(a,b))return a.username;var c=n.Xr(a,b);if(c)return c.username;for(c=0;c<a.oa.length;c++){var d=a.oa[c],e;for(e=0;e<d.m_pContactArray.length;e++){var f=
d.m_pContactArray[e];if(f.id==b)return f.name}}return b};n.jm_info_GetOfficeCount=n.yD=function(){return x.la.length}})(window.hmtg);
